...
- Build date: 2016-10-28T17:25:09.473-03:00
...
*Pier.StatusContaApi* | [**listarUsingGET4**](docs/StatusContaApi.md#listarUsingGET4) | **GET** /api/status-contas | Lista os Status Contas cadastrados para o Emissor
...
*Pier.StatusImpressaoApi* | [**listarUsingGET5**](docs/StatusImpressaoApi.md#listarUsingGET5) | **GET** /api/status-impressoes | Lista as op\u00C3\u00A7\u00C3\u00B5es de Status Impress\u00C3\u00A3o

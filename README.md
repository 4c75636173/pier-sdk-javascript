...
- Build date: 2017-01-19T19:38:53.563-03:00
...
*Pier.ContaApi* | [**listarFaturasUsingGET**](docs/ContaApi.md#listarFaturasUsingGET) | **GET** /api/contas/{id_conta}/faturas | Listar Faturas da Conta
...
*Pier.ContaApi* | [**transacoesUsingPOST**](docs/ContaApi.md#transacoesUsingPOST) | **POST** /api/contas/{id_conta}/timeline | Permite listar uma linha do tempo com os eventos da conta

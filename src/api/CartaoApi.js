...
var $, ConsultarCartaoResponse, CancelarCartaoResponse, DesbloquearCartaoResponse, ConsultarExtratoContaResponse, ConsultarSaldoLimitesResponse;
...
if ( typeof define === "function" && define.amd ) {     
	define(['jquery', 'ConsultarCartaoResponse', 'CancelarCartaoResponse', 'DesbloquearCartaoResponse', 'ConsultarExtratoContaResponse', 'ConsultarSaldoLimitesResponse'], function($, ConsultarCartaoResponse, CancelarCartaoResponse, DesbloquearCartaoResponse, ConsultarExtratoContaResponse, ConsultarSaldoLimitesResponse) {
        return CartaoApi;
	 });
}

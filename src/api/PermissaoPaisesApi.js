(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PermissaoPaisesApi = factory(root.Pier.ApiClient, root.Pier.PaisResponse, root.Pier.PagePaisResponse);
  }
  ...
  /**
   * Constructs a new PermissaoPaisesApi. 
   * @alias module:api/PermissaoPaisesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/PermissaoPaisesApi~consultarPaisUsingGETCallback
     ...
     * @param {module:api/PermissaoPaisesApi~consultarPaisUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PermissaoPaisesApi~listarContinentesUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PermissaoPaisesApi~listarContinentesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/PermissaoPaisesApi~listarPaisesUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/PermissaoPaisesApi~listarPaisesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response

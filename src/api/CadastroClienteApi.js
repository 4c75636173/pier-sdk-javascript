(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/CadastroClienteApi~consultarUsingGET29Callback
     * @param {String} error Error message, if any.
     * @param {module:model/TelefoneResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} id C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Telefone (id).
     * @param {module:api/CadastroClienteApi~consultarUsingGET29Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/TelefoneResponse}
     */
     ...
     * @callback module:api/CadastroClienteApi~listarUsingGET27Callback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.email Email da pessoa fisica
     * @param {String} opts.nomeEmpresa Nome que deve ser impresso no cart\u00C3\u00A3o
     * @param {module:api/CadastroClienteApi~listarUsingGET27Callback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CadastroClienteApi~listarUsingGET28Callback
     * @param {String} error Error message, if any.
     * @param {module:model/PagePessoaResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/CadastroClienteApi~listarUsingGET28Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/PagePessoaResponse}
     */
     ...
     * @callback module:api/CadastroClienteApi~listarUsingGET37Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CadastroClienteApi~listarUsingGET37Callback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CadastroClienteApi~salvarUsingPOST18Callback
     * @param {String} error Error message, if any.
     * @param {module:model/PessoaDetalheResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.email Email da pessoa fisica
     * @param {String} opts.nomeEmpresa Nome que deve ser impresso no cart\u00C3\u00A3o
     * @param {module:api/CadastroClienteApi~salvarUsingPOST18Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/PessoaDetalheResponse}
     */
    this.salvarUsingPOST18 = function(idPessoa, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'idPessoa' is set
      if (idPessoa == undefined || idPessoa == null) {
        throw "Missing the required parameter 'idPessoa' when calling salvarUsingPOST18";
      }
     ...
     * data is of type: {module:model/PessoaResponse}
     */
    this.salvarUsingPOST19 = function(nome, tipo, dataNascimento, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'nome' is set
      if (nome == undefined || nome == null) {
        throw "Missing the required parameter 'nome' when calling salvarUsingPOST19";
      }

      // verify the required parameter 'tipo' is set
      if (tipo == undefined || tipo == null) {
        throw "Missing the required parameter 'tipo' when calling salvarUsingPOST19";
      }

      // verify the required parameter 'dataNascimento' is set
      if (dataNascimento == undefined || dataNascimento == null) {
        throw "Missing the required parameter 'dataNascimento' when calling salvarUsingPOST19";
      }
     ...
     * @callback module:api/CadastroClienteApi~salvarUsingPOST22Callback
     * @param {String} error Error message, if any.
     * @param {module:model/TelefoneResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.telefone N\u00C3\u00BAmero do telefone.
     * @param {String} opts.ramal N\u00C3\u00BAmero do ramal.
     * @param {module:api/CadastroClienteApi~salvarUsingPOST22Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/TelefoneResponse}
     */
    this.salvarUsingPOST22 = function(opts, callback) {
      opts = opts || {};
      var postBody = null;

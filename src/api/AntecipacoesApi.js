(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.AntecipacoesApi = factory(root.Pier.ApiClient, root.Pier.ParametroProdutoResponse, root.Pier.TaxaAntecipacaoRequest, root.Pier.AntecipacaoResponse, root.Pier.PageCompraResponse, root.Pier.AntecipacaoSimuladaResponse);
  }
  ...
  /**
   * Constructs a new AntecipacoesApi. 
   * @alias module:api/AntecipacoesApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/AntecipacoesApi~configurarTaxaAntecipacaoUsingPOSTCallback
     ...
     * @param {module:api/AntecipacoesApi~configurarTaxaAntecipacaoUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/AntecipacoesApi~consultarTaxaAntecipacaoUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ParametroProdutoResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AntecipacoesApi~consultarTaxaAntecipacaoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/ParametroProdutoResponse}
     */
     ...
     * @callback module:api/AntecipacoesApi~efetivarAntecipacaoUsingPOSTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/AntecipacoesApi~efetivarAntecipacaoUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/AntecipacoesApi~simularAntecipacaoUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Integer} idConta C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta.
     * @param {Integer} id C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do evento.
     * @param {module:api/AntecipacoesApi~simularAntecipacaoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response

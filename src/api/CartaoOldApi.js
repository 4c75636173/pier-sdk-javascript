(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.CartaoOldApi = factory(root.Pier.ApiClient, root.Pier.CancelarCartaoResponse, root.Pier.ConsultarCartaoResponse, root.Pier.DesbloquearCartaoResponse, root.Pier.EmbossadoCartaoResponse);
  }
  ...
  /**
   * CartaoOld service.
   * @module api/CartaoOldApi
   * @version 1.1.0
   */

  /**
   * Constructs a new CartaoOldApi. 
   * @alias module:api/CartaoOldApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/CartaoOldApi~bloquearCartaoUsingPOSTCallback
     ...
     * @param {module:api/CartaoOldApi~bloquearCartaoUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CartaoOldApi~consultarCartaoUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CartaoOldApi~consultarCartaoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CartaoOldApi~consultarCartoesUsingGETCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ConsultarCartaoResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} idConta ID da Conta
     * @param {module:api/CartaoOldApi~consultarCartoesUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/ConsultarCartaoResponse}
     */
     ...
     * @callback module:api/CartaoOldApi~desbloquearCartaoUsingPOSTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CartaoOldApi~desbloquearCartaoUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/CartaoOldApi~embossadoCartaoUsingPUTCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Integer} idConta ID da Conta
     * @param {Integer} idCartao ID do Cart\u00C3\u00A3o que deseja cancelar
     * @param {module:api/CartaoOldApi~embossadoCartaoUsingPUTCallback} callback The callback function, accepting three arguments: error, data, response

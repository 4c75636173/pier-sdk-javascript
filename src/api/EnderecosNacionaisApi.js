(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.EnderecosNacionaisApi = factory(root.Pier.ApiClient, root.Pier.EnderecoResponse);
  }
  ...
  /**
   * Constructs a new EnderecosNacionaisApi. 
   * @alias module:api/EnderecosNacionaisApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/EnderecosNacionaisApi~consultarEnderecoUsingGETCallback
     ...
     * @param {module:api/EnderecosNacionaisApi~consultarEnderecoUsingGETCallback} callback The callback function, accepting three arguments: error, data, response

(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/StatusParametroApi~listarUsingGET32Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StatusParametroApi~listarUsingGET32Callback} callback The callback function, accepting three arguments: error, data, response

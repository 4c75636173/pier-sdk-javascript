(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.ServicosContaApi = factory(root.Pier.ApiClient, root.Pier.PageAnuidadeResponse, root.Pier.PageOperadoraResponse);
  }
  ...
  /**
   * Constructs a new ServicosContaApi. 
   * @alias module:api/ServicosContaApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ServicosContaApi~ativarAnuidadeUsingPOSTCallback
     ...
     * @param {module:api/ServicosContaApi~ativarAnuidadeUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ServicosContaApi~ativarEnvioFaturaEmailUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} id C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta (id).
     * @param {module:api/ServicosContaApi~ativarEnvioFaturaEmailUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {Object}
     */
     ...
     * @callback module:api/ServicosContaApi~desativarEnvioFaturaEmailUsingPOSTCallback
     * @param {String} error Error message, if any.
     * @param {Object} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} id C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta (id).
     * @param {module:api/ServicosContaApi~desativarEnvioFaturaEmailUsingPOSTCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {Object}
     */
     ...
     * @callback module:api/ServicosContaApi~listarAnuidadesUsingGETCallback
     * @param {String} error Error message, if any.
     ...
     * @callback module:api/ServicosContaApi~listarOperadorasTelefonicasUsingGETCallback
     * @param {String} error Error message, if any.

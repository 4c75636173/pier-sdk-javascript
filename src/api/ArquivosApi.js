(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.ArquivosApi = factory(root.Pier.ApiClient, root.Pier.ArquivoResponse, root.Pier.ArquivoPersist);
  }
  ...
  /**
   * Arquivos service.
   * @module api/ArquivosApi
   * @version 2.24.0
   */

  /**
   * Constructs a new ArquivosApi. 
   * @alias module:api/ArquivosApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/ArquivosApi~consultarUsingGETCallback
     ...
     * @param {module:api/ArquivosApi~consultarUsingGETCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/ArquivosApi~salvarUsingPOST1Callback
     * @param {String} error Error message, if any.
     * @param {module:model/ArquivoResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/ArquivosApi~salvarUsingPOST1Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/ArquivoResponse}
     */

(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Integer} idConta C\u00F3digo identificador da conta.
     ...
     * @callback module:api/AjusteFinanceiroApi~consultarUsingGET2Callback
     * @param {String} error Error message, if any.
     * @param {module:model/AjusteFinanceiroResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Integer} id C\u00F3digo de identifica\u00E7\u00E3o do ajuste (id).
     * @param {module:api/AjusteFinanceiroApi~consultarUsingGET2Callback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {module:model/AjusteFinanceiroResponse}
     */
     ...
     * @callback module:api/AjusteFinanceiroApi~listarUsingGET2Callback
     * @param {String} error Error message, if any.
     ...
     * @param {Integer} opts.idTipoAjuste C\u00F3digo identificador do tipo de ajuste.
     ...
     * @param {String} opts.identificadorExterno Codigo Hexadecimal
     * @param {Integer} opts.idConta C\u00F3digo identificador da conta.
     * @param {module:api/AjusteFinanceiroApi~listarUsingGET2Callback} callback The callback function, accepting three arguments: error, data, response

(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/StatusParametrosApi~listarUsingGET22Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StatusParametrosApi~listarUsingGET22Callback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/StatusParametrosApi~listarUsingGET23Callback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/StatusParametrosApi~listarUsingGET23Callback} callback The callback function, accepting three arguments: error, data, response

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.ConfiguracaoRotativoDetalheResponse = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>ConfiguracaoRotativoDetalheResponse</code>.
   * Objeto conta
   * @alias module:model/ConfiguracaoRotativoDetalheResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ConfiguracaoRotativoDetalheResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ConfiguracaoRotativoDetalheResponse} obj Optional instance to populate.
   * @return {module:model/ConfiguracaoRotativoDetalheResponse} The populated <code>ConfiguracaoRotativoDetalheResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './DispositivoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DispositivoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageDispositivoResponse = factory(root.Pier.ApiClient, root.Pier.DispositivoResponse);
  }
}(this, function(ApiClient, DispositivoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageDispositivoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDispositivoResponse} obj Optional instance to populate.
   * @return {module:model/PageDispositivoResponse} The populated <code>PageDispositivoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [DispositivoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/DispositivoResponse>} content
   */

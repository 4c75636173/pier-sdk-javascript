(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './LinkTransferenciaBancariaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LinkTransferenciaBancariaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.LinkPageTransferenciaBancariaResponse = factory(root.Pier.ApiClient, root.Pier.LinkTransferenciaBancariaResponse);
  }
}(this, function(ApiClient, LinkTransferenciaBancariaResponse) {
  'use strict';

  /**
   * The LinkPageTransferenciaBancariaResponse model module.
   * @module model/LinkPageTransferenciaBancariaResponse
   * @version 2.13.0
   */

  /**
   * Constructs a new <code>LinkPageTransferenciaBancariaResponse</code>.
   * Lista de Transfer\u00C3\u00AAncias
   * @alias module:model/LinkPageTransferenciaBancariaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>LinkPageTransferenciaBancariaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinkPageTransferenciaBancariaResponse} obj Optional instance to populate.
   * @return {module:model/LinkPageTransferenciaBancariaResponse} The populated <code>LinkPageTransferenciaBancariaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [LinkTransferenciaBancariaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/LinkTransferenciaBancariaResponse>} content
   */

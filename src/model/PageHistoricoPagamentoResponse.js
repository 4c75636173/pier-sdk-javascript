(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './HistoricoPagamentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HistoricoPagamentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageHistoricoPagamentoResponse = factory(root.Pier.ApiClient, root.Pier.HistoricoPagamentoResponse);
  }
}(this, function(ApiClient, HistoricoPagamentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageHistoricoPagamentoResponse</code>.
   * Lista de pagamentos
   * @alias module:model/PageHistoricoPagamentoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageHistoricoPagamentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageHistoricoPagamentoResponse} obj Optional instance to populate.
   * @return {module:model/PageHistoricoPagamentoResponse} The populated <code>PageHistoricoPagamentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [HistoricoPagamentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/HistoricoPagamentoResponse>} content
   */

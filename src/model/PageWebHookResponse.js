(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './WebHookResponse'], factory);
    ...
    root.Pier.PageWebHookResponse = factory(root.Pier.ApiClient, root.Pier.WebHookResponse);
  }
  ...
  /**
   * Constructs a <code>PageWebHookResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageWebHookResponse} obj Optional instance to populate.
   * @return {module:model/PageWebHookResponse} The populated <code>PageWebHookResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [WebHookResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/WebHookResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './OperacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OperacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageOperacaoResponse = factory(root.Pier.ApiClient, root.Pier.OperacaoResponse);
  }
}(this, function(ApiClient, OperacaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageOperacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOperacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageOperacaoResponse} The populated <code>PageOperacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [OperacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/OperacaoResponse>} content
   */

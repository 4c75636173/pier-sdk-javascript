(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './NotificacaoSMSResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NotificacaoSMSResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageSMSResponse = factory(root.Pier.ApiClient, root.Pier.NotificacaoSMSResponse);
  }
}(this, function(ApiClient, NotificacaoSMSResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageSMSResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageSMSResponse} obj Optional instance to populate.
   * @return {module:model/PageSMSResponse} The populated <code>PageSMSResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [NotificacaoSMSResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/NotificacaoSMSResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageTipoAjusteResponse = factory(root.Pier.ApiClient, root.Pier.TipoAjusteResponse);
  }
  ...
  /**
   * Constructs a <code>PageTipoAjusteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoAjusteResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoAjusteResponse} The populated <code>PageTipoAjusteResponse</code> instance.
   */

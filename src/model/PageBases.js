(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Base'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Base'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBases = factory(root.Pier.ApiClient, root.Pier.Base);
  }
}(this, function(ApiClient, Base) {
  'use strict';

  /**
   * The PageBases model module.
   * @module model/PageBases
   * @version 2.15.0
   */

  /**
   * Constructs a new <code>PageBases</code>.
   * Lista de Bases
   * @alias module:model/PageBases
   * @class
   */
  ...
  /**
   * Constructs a <code>PageBases</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBases} obj Optional instance to populate.
   * @return {module:model/PageBases} The populated <code>PageBases</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Base]);
      }
  ...
  /**
   * @member {Array.<module:model/Base>} content
   */

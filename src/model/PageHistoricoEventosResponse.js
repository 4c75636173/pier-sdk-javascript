(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './HistoricoEventosResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HistoricoEventosResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageHistoricoEventosResponse = factory(root.Pier.ApiClient, root.Pier.HistoricoEventosResponse);
  }
}(this, function(ApiClient, HistoricoEventosResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageHistoricoEventosResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageHistoricoEventosResponse} obj Optional instance to populate.
   * @return {module:model/PageHistoricoEventosResponse} The populated <code>PageHistoricoEventosResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [HistoricoEventosResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/HistoricoEventosResponse>} content
   */

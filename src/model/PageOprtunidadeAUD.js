(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageOprtunidadeAUD = factory(root.Pier.ApiClient, root.Pier.OportunidadeAUDResponse);
  }
  ...
  /**
   * Constructs a new <code>PageOprtunidadeAUD</code>.
   * Lista de auditorias da oportunidade
   * @alias module:model/PageOprtunidadeAUD
   * @class
   */
  ...
  /**
   * Constructs a <code>PageOprtunidadeAUD</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOprtunidadeAUD} obj Optional instance to populate.
   * @return {module:model/PageOprtunidadeAUD} The populated <code>PageOprtunidadeAUD</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoDebitoRecorrenteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoDebitoRecorrenteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoDebitoRecorrenteResponse = factory(root.Pier.ApiClient, root.Pier.TipoDebitoRecorrenteResponse);
  }
}(this, function(ApiClient, TipoDebitoRecorrenteResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoDebitoRecorrenteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoDebitoRecorrenteResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoDebitoRecorrenteResponse} The populated <code>PageTipoDebitoRecorrenteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoDebitoRecorrenteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoDebitoRecorrenteResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Estabelecimento'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Estabelecimento'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageEstabelecimentos = factory(root.Pier.ApiClient, root.Pier.Estabelecimento);
  }
}(this, function(ApiClient, Estabelecimento) {
  'use strict';

  /**
   * The PageEstabelecimentos model module.
   * @module model/PageEstabelecimentos
   * @version 2.15.5
   */

  /**
   * Constructs a new <code>PageEstabelecimentos</code>.
   * Lista de estabelecimentos
   * @alias module:model/PageEstabelecimentos
   * @class
   */
  ...
  /**
   * Constructs a <code>PageEstabelecimentos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageEstabelecimentos} obj Optional instance to populate.
   * @return {module:model/PageEstabelecimentos} The populated <code>PageEstabelecimentos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Estabelecimento]);
      }
  ...
  /**
   * @member {Array.<module:model/Estabelecimento>} content
   */

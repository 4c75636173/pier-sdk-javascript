(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ArquivoAUDResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ArquivoAUDResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageArquivoAUDResponse = factory(root.Pier.ApiClient, root.Pier.ArquivoAUDResponse);
  }
}(this, function(ApiClient, ArquivoAUDResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageArquivoAUDResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageArquivoAUDResponse} obj Optional instance to populate.
   * @return {module:model/PageArquivoAUDResponse} The populated <code>PageArquivoAUDResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ArquivoAUDResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ArquivoAUDResponse>} content
   */

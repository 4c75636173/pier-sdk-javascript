(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.Estabelecimento = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>Estabelecimento</code>.
   * Objeto Estabelecimento
   * @alias module:model/Estabelecimento
   * @class
   */
  ...
  /**
   * Constructs a <code>Estabelecimento</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Estabelecimento} obj Optional instance to populate.
   * @return {module:model/Estabelecimento} The populated <code>Estabelecimento</code> instance.
   */

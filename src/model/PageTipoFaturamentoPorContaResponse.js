(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoFaturamentoPorContaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoFaturamentoPorContaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoFaturamentoPorContaResponse = factory(root.Pier.ApiClient, root.Pier.TipoFaturamentoPorContaResponse);
  }
}(this, function(ApiClient, TipoFaturamentoPorContaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoFaturamentoPorContaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoFaturamentoPorContaResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoFaturamentoPorContaResponse} The populated <code>PageTipoFaturamentoPorContaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoFaturamentoPorContaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoFaturamentoPorContaResponse>} content
   */

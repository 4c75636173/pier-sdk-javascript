(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusImpressaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusImpressaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusImpressaoResponse = factory(root.Pier.ApiClient, root.Pier.StatusImpressaoResponse);
  }
}(this, function(ApiClient, StatusImpressaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageStatusImpressaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusImpressaoResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusImpressaoResponse} The populated <code>PageStatusImpressaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusImpressaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusImpressaoResponse>} content
   */

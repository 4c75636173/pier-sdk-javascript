(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './RiscoFraudeResponseValue'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./RiscoFraudeResponseValue'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageRiscoFraudeResponseValue = factory(root.Pier.ApiClient, root.Pier.RiscoFraudeResponseValue);
  }
}(this, function(ApiClient, RiscoFraudeResponseValue) {
  'use strict';

  /**
   * The PageRiscoFraudeResponseValue model module.
   * @module model/PageRiscoFraudeResponseValue
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageRiscoFraudeResponseValue</code>.
   * {{{page_risco_fraude_response_description}}}
   * @alias module:model/PageRiscoFraudeResponseValue
   * @class
   */
  ...
  /**
   * Constructs a <code>PageRiscoFraudeResponseValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageRiscoFraudeResponseValue} obj Optional instance to populate.
   * @return {module:model/PageRiscoFraudeResponseValue} The populated <code>PageRiscoFraudeResponseValue</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [RiscoFraudeResponseValue]);
      }
  ...
  /**
   * @member {Array.<module:model/RiscoFraudeResponseValue>} content
   */

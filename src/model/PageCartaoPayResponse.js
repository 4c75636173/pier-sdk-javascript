(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CartaoPayResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CartaoPayResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCartaoPayResponse = factory(root.Pier.ApiClient, root.Pier.CartaoPayResponse);
  }
}(this, function(ApiClient, CartaoPayResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageCartaoPayResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCartaoPayResponse} obj Optional instance to populate.
   * @return {module:model/PageCartaoPayResponse} The populated <code>PageCartaoPayResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CartaoPayResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CartaoPayResponse>} content
   */

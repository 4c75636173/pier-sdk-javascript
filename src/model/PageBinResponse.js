(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './BinResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BinResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBinResponse = factory(root.Pier.ApiClient, root.Pier.BinResponse);
  }
}(this, function(ApiClient, BinResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageBinResponse</code>.
   * {{{page_bin_response_description}}}
   * @alias module:model/PageBinResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageBinResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBinResponse} obj Optional instance to populate.
   * @return {module:model/PageBinResponse} The populated <code>PageBinResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BinResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/BinResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PagePessoas = factory(root.Pier.ApiClient, root.Pier.Pessoa);
  }
  ...
  /**
   * Constructs a new <code>PagePessoas</code>.
   * Lista de Pessoas
   * @alias module:model/PagePessoas
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePessoas</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePessoas} obj Optional instance to populate.
   * @return {module:model/PagePessoas} The populated <code>PagePessoas</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Pessoa]);
      }
  ...
  /**
   * @member {Array.<module:model/Pessoa>} content
   */

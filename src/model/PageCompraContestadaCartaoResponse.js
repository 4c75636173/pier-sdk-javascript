(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CompraContestadaCartaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompraContestadaCartaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCompraContestadaCartaoResponse = factory(root.Pier.ApiClient, root.Pier.CompraContestadaCartaoResponse);
  }
}(this, function(ApiClient, CompraContestadaCartaoResponse) {
  'use strict';

  /**
   * The PageCompraContestadaCartaoResponse model module.
   * @module model/PageCompraContestadaCartaoResponse
   * @version 2.74.2
   */

  /**
   * Constructs a new <code>PageCompraContestadaCartaoResponse</code>.
   * {{{page_page_compra_contestada_cartao_response_description}}}
   * @alias module:model/PageCompraContestadaCartaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCompraContestadaCartaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCompraContestadaCartaoResponse} obj Optional instance to populate.
   * @return {module:model/PageCompraContestadaCartaoResponse} The populated <code>PageCompraContestadaCartaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CompraContestadaCartaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CompraContestadaCartaoResponse>} content
   */

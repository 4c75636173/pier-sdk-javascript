(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageTelefoneResponse = factory(root.Pier.ApiClient, root.Pier.TelefoneResponse);
  }
  ...
  /**
   * Constructs a <code>PageTelefoneResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTelefoneResponse} obj Optional instance to populate.
   * @return {module:model/PageTelefoneResponse} The populated <code>PageTelefoneResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TelefoneResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TelefoneResponse>} content
   */

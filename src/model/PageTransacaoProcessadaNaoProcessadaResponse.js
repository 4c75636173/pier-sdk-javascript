(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransacaoProcessadaNaoProcessadaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransacaoProcessadaNaoProcessadaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransacaoProcessadaNaoProcessadaResponse = factory(root.Pier.ApiClient, root.Pier.TransacaoProcessadaNaoProcessadaResponse);
  }
}(this, function(ApiClient, TransacaoProcessadaNaoProcessadaResponse) {
  'use strict';

  /**
   * The PageTransacaoProcessadaNaoProcessadaResponse model module.
   * @module model/PageTransacaoProcessadaNaoProcessadaResponse
   * @version 2.66.1
   */

  /**
   * Constructs a new <code>PageTransacaoProcessadaNaoProcessadaResponse</code>.
   * {{{page_transacao_processada_nao_processada_response_description}}}
   * @alias module:model/PageTransacaoProcessadaNaoProcessadaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTransacaoProcessadaNaoProcessadaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransacaoProcessadaNaoProcessadaResponse} obj Optional instance to populate.
   * @return {module:model/PageTransacaoProcessadaNaoProcessadaResponse} The populated <code>PageTransacaoProcessadaNaoProcessadaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransacaoProcessadaNaoProcessadaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TransacaoProcessadaNaoProcessadaResponse>} content
   */

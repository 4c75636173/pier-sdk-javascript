(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoOportunidadeAUDResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoOportunidadeAUDResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoOprtunidadesAUD = factory(root.Pier.ApiClient, root.Pier.TipoOportunidadeAUDResponse);
  }
}(this, function(ApiClient, TipoOportunidadeAUDResponse) {
  'use strict';

  /**
   * The PageTipoOprtunidadesAUD model module.
   * @module model/PageTipoOprtunidadesAUD
   * @version 2.15.5
   */

  /**
   * Constructs a new <code>PageTipoOprtunidadesAUD</code>.
   * Lista de auditorias dos tipos oportunidades
   * @alias module:model/PageTipoOprtunidadesAUD
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoOprtunidadesAUD</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoOprtunidadesAUD} obj Optional instance to populate.
   * @return {module:model/PageTipoOprtunidadesAUD} The populated <code>PageTipoOprtunidadesAUD</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoOportunidadeAUDResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoOportunidadeAUDResponse>} content
   */

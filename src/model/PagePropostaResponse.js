(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PropostaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PropostaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePropostaResponse = factory(root.Pier.ApiClient, root.Pier.PropostaResponse);
  }
}(this, function(ApiClient, PropostaResponse) {
  'use strict';

  /**
   * The PagePropostaResponse model module.
   * @module model/PagePropostaResponse
   * @version 2.74.2
   */

  /**
   * Constructs a new <code>PagePropostaResponse</code>.
   * {{{page_proposta_listar_response_description}}}
   * @alias module:model/PagePropostaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePropostaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePropostaResponse} obj Optional instance to populate.
   * @return {module:model/PagePropostaResponse} The populated <code>PagePropostaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PropostaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PropostaResponse>} content
   */

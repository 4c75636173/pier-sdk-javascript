(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.AtendimentoCliente = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>AtendimentoCliente</code>.
   * Objeto AtendimentoCliente
   * @alias module:model/AtendimentoCliente
   * @class
   */
  ...
  /**
   * Constructs a <code>AtendimentoCliente</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AtendimentoCliente} obj Optional instance to populate.
   * @return {module:model/AtendimentoCliente} The populated <code>AtendimentoCliente</code> instance.
   */

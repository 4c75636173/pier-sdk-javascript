(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './FAQ'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FAQ'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageFaqs = factory(root.Pier.ApiClient, root.Pier.FAQ);
  }
}(this, function(ApiClient, FAQ) {
  'use strict';

  /**
   * The PageFaqs model module.
   * @module model/PageFaqs
   * @version 2.8.0
   */

  /**
   * Constructs a new <code>PageFaqs</code>.
   * Lista de FAQs
   * @alias module:model/PageFaqs
   * @class
   */
  ...
  /**
   * Constructs a <code>PageFaqs</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFaqs} obj Optional instance to populate.
   * @return {module:model/PageFaqs} The populated <code>PageFaqs</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [FAQ]);
      }
  ...
  /**
   * @member {Array.<module:model/FAQ>} content
   */

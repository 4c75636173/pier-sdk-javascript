(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.CartaoPayDetalheResponse = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a <code>CartaoPayDetalheResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CartaoPayDetalheResponse} obj Optional instance to populate.
   * @return {module:model/CartaoPayDetalheResponse} The populated <code>CartaoPayDetalheResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CompraContestadaTransacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompraContestadaTransacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCompraContestadaTransacaoResponse = factory(root.Pier.ApiClient, root.Pier.CompraContestadaTransacaoResponse);
  }
}(this, function(ApiClient, CompraContestadaTransacaoResponse) {
  'use strict';

  /**
   * The PageCompraContestadaTransacaoResponse model module.
   * @module model/PageCompraContestadaTransacaoResponse
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageCompraContestadaTransacaoResponse</code>.
   * {{{page_compra_contestada_transacao_response_description}}}
   * @alias module:model/PageCompraContestadaTransacaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCompraContestadaTransacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCompraContestadaTransacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageCompraContestadaTransacaoResponse} The populated <code>PageCompraContestadaTransacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CompraContestadaTransacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CompraContestadaTransacaoResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusCartaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusCartaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusCartaoResponse = factory(root.Pier.ApiClient, root.Pier.StatusCartaoResponse);
  }
}(this, function(ApiClient, StatusCartaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageStatusCartaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusCartaoResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusCartaoResponse} The populated <code>PageStatusCartaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusCartaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusCartaoResponse>} content
   */

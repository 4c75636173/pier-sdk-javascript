(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PerfilResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PerfilResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePerfilResponse = factory(root.Pier.ApiClient, root.Pier.PerfilResponse);
  }
}(this, function(ApiClient, PerfilResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PagePerfilResponse</code>.
   * {{{page_perfil_response_object_description}}}
   * @alias module:model/PagePerfilResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePerfilResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePerfilResponse} obj Optional instance to populate.
   * @return {module:model/PagePerfilResponse} The populated <code>PagePerfilResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PerfilResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PerfilResponse>} content
   */

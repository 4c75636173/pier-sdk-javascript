(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './OportunidadeAUDResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OportunidadeAUDResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageOportunidadeAUDResponse = factory(root.Pier.ApiClient, root.Pier.OportunidadeAUDResponse);
  }
}(this, function(ApiClient, OportunidadeAUDResponse) {
  'use strict';

  /**
   * The PageOportunidadeAUDResponse model module.
   * @module model/PageOportunidadeAUDResponse
   * @version 2.16.6
   */

  /**
   * Constructs a new <code>PageOportunidadeAUDResponse</code>.
   * Lista de auditorias da oportunidade
   * @alias module:model/PageOportunidadeAUDResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageOportunidadeAUDResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOportunidadeAUDResponse} obj Optional instance to populate.
   * @return {module:model/PageOportunidadeAUDResponse} The populated <code>PageOportunidadeAUDResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [OportunidadeAUDResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/OportunidadeAUDResponse>} content
   */

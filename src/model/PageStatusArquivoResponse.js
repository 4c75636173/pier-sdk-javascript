(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusArquivoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusArquivoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusArquivoResponse = factory(root.Pier.ApiClient, root.Pier.StatusArquivoResponse);
  }
}(this, function(ApiClient, StatusArquivoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageStatusArquivoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusArquivoResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusArquivoResponse} The populated <code>PageStatusArquivoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusArquivoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusArquivoResponse>} content
   */

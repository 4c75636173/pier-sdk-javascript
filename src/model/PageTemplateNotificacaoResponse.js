(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TemplateNotificacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TemplateNotificacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTemplateNotificacaoResponse = factory(root.Pier.ApiClient, root.Pier.TemplateNotificacaoResponse);
  }
}(this, function(ApiClient, TemplateNotificacaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTemplateNotificacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTemplateNotificacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageTemplateNotificacaoResponse} The populated <code>PageTemplateNotificacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TemplateNotificacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TemplateNotificacaoResponse>} content
   */

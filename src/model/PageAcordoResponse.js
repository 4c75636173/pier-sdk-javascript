(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AcordoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AcordoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAcordoResponse = factory(root.Pier.ApiClient, root.Pier.AcordoResponse);
  }
}(this, function(ApiClient, AcordoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageAcordoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAcordoResponse} obj Optional instance to populate.
   * @return {module:model/PageAcordoResponse} The populated <code>PageAcordoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AcordoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AcordoResponse>} content
   */

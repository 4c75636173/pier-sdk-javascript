(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusOportunidadeAUDResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusOportunidadeAUDResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusOprtunidadesAUD = factory(root.Pier.ApiClient, root.Pier.StatusOportunidadeAUDResponse);
  }
}(this, function(ApiClient, StatusOportunidadeAUDResponse) {
  'use strict';

  /**
   * The PageStatusOprtunidadesAUD model module.
   * @module model/PageStatusOprtunidadesAUD
   * @version 2.15.5
   */

  /**
   * Constructs a new <code>PageStatusOprtunidadesAUD</code>.
   * Lista de auditorias dos status oportunidades
   * @alias module:model/PageStatusOprtunidadesAUD
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStatusOprtunidadesAUD</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusOprtunidadesAUD} obj Optional instance to populate.
   * @return {module:model/PageStatusOprtunidadesAUD} The populated <code>PageStatusOprtunidadesAUD</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusOportunidadeAUDResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusOportunidadeAUDResponse>} content
   */

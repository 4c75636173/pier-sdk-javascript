(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PagePessoaDetalheResponse = factory(root.Pier.ApiClient, root.Pier.PessoaDetalheResponse);
  }
}(this, function(ApiClient, PessoaDetalheResponse) {
  'use strict';

  /**
   * The PagePessoaDetalheResponse model module.
   * @module model/PagePessoaDetalheResponse
   * @version 2.54.2
   */

  /**
   * Constructs a new <code>PagePessoaDetalheResponse</code>.
   * Lista de PessoaDetalheResponse
   * @alias module:model/PagePessoaDetalheResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePessoaDetalheResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePessoaDetalheResponse} obj Optional instance to populate.
   * @return {module:model/PagePessoaDetalheResponse} The populated <code>PagePessoaDetalheResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageTelefones = factory(root.Pier.ApiClient, root.Pier.Telefone);
  }
}(this, function(ApiClient, Telefone) {
  'use strict';

  /**
   * The PageTelefones model module.
   * @module model/PageTelefones
   * @version 2.15.5
   */

  /**
   * Constructs a new <code>PageTelefones</code>.
   * Lista de telefones
   * @alias module:model/PageTelefones
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTelefones</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTelefones} obj Optional instance to populate.
   * @return {module:model/PageTelefones} The populated <code>PageTelefones</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Telefone]);
      }
  ...
  /**
   * @member {Array.<module:model/Telefone>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './DocumentoTemplateResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DocumentoTemplateResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageDocumentoTemplateResponse = factory(root.Pier.ApiClient, root.Pier.DocumentoTemplateResponse);
  }
}(this, function(ApiClient, DocumentoTemplateResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageDocumentoTemplateResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDocumentoTemplateResponse} obj Optional instance to populate.
   * @return {module:model/PageDocumentoTemplateResponse} The populated <code>PageDocumentoTemplateResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [DocumentoTemplateResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/DocumentoTemplateResponse>} content
   */

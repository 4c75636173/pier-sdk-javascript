(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageApiOfEstagioCartao = factory(root.Pier.ApiClient, root.Pier.EstagioCartao);
  }
}(this, function(ApiClient, EstagioCartao) {
  'use strict';

  /**
   * The PageApiOfEstagioCartao model module.
   * @module model/PageApiOfEstagioCartao
   * @version 1.1.0
   */

  /**
   * Constructs a new <code>PageApiOfEstagioCartao</code>.
   * @alias module:model/PageApiOfEstagioCartao
   * @class
   */
  ...
  /**
   * Constructs a <code>PageApiOfEstagioCartao</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageApiOfEstagioCartao} obj Optional instance to populate.
   * @return {module:model/PageApiOfEstagioCartao} The populated <code>PageApiOfEstagioCartao</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [EstagioCartao]);
      }
  ...
  /**
   * @member {Array.<module:model/EstagioCartao>} content
   */

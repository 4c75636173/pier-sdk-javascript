(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageTipoOportunidadeAUDResponse = factory(root.Pier.ApiClient, root.Pier.TipoOportunidadeAUDResponse);
  }
  ...
  /**
   * Constructs a <code>PageTipoOportunidadeAUDResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoOportunidadeAUDResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoOportunidadeAUDResponse} The populated <code>PageTipoOportunidadeAUDResponse</code> instance.
   */

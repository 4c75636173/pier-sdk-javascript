(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CampanhaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CampanhaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCampanhaResponse = factory(root.Pier.ApiClient, root.Pier.CampanhaResponse);
  }
}(this, function(ApiClient, CampanhaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageCampanhaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCampanhaResponse} obj Optional instance to populate.
   * @return {module:model/PageCampanhaResponse} The populated <code>PageCampanhaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CampanhaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CampanhaResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoTelefone'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoTelefone'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoTelefones = factory(root.Pier.ApiClient, root.Pier.TipoTelefone);
  }
}(this, function(ApiClient, TipoTelefone) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTipoTelefones</code>.
   * Lista de tipos telefones
   * @alias module:model/PageTipoTelefones
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoTelefones</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoTelefones} obj Optional instance to populate.
   * @return {module:model/PageTipoTelefones} The populated <code>PageTipoTelefones</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoTelefone]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoTelefone>} content
   */

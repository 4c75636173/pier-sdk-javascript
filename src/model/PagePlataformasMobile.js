(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PlataformaMobile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PlataformaMobile'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePlataformasMobile = factory(root.Pier.ApiClient, root.Pier.PlataformaMobile);
  }
}(this, function(ApiClient, PlataformaMobile) {
  'use strict';

  /**
   * The PagePlataformasMobile model module.
   * @module model/PagePlataformasMobile
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PagePlataformasMobile</code>.
   * Lista de Plataformas Mobile
   * @alias module:model/PagePlataformasMobile
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePlataformasMobile</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePlataformasMobile} obj Optional instance to populate.
   * @return {module:model/PagePlataformasMobile} The populated <code>PagePlataformasMobile</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PlataformaMobile]);
      }
  ...
  /**
   * @member {Array.<module:model/PlataformaMobile>} content
   */

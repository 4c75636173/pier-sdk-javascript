(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './SMSEnvioResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SMSEnvioResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageSMSEnvioResponse = factory(root.Pier.ApiClient, root.Pier.SMSEnvioResponse);
  }
}(this, function(ApiClient, SMSEnvioResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageSMSEnvioResponse</code>.
   * {{{page_sms_envio_response_description}}}
   * @alias module:model/PageSMSEnvioResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageSMSEnvioResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageSMSEnvioResponse} obj Optional instance to populate.
   * @return {module:model/PageSMSEnvioResponse} The populated <code>PageSMSEnvioResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [SMSEnvioResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/SMSEnvioResponse>} content
   */

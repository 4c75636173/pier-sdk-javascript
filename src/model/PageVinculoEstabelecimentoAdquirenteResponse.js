(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './VinculoEstabelecimentoAdquirenteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VinculoEstabelecimentoAdquirenteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageVinculoEstabelecimentoAdquirenteResponse = factory(root.Pier.ApiClient, root.Pier.VinculoEstabelecimentoAdquirenteResponse);
  }
}(this, function(ApiClient, VinculoEstabelecimentoAdquirenteResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageVinculoEstabelecimentoAdquirenteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageVinculoEstabelecimentoAdquirenteResponse} obj Optional instance to populate.
   * @return {module:model/PageVinculoEstabelecimentoAdquirenteResponse} The populated <code>PageVinculoEstabelecimentoAdquirenteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [VinculoEstabelecimentoAdquirenteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/VinculoEstabelecimentoAdquirenteResponse>} content
   */

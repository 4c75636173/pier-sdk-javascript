(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PermissaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PermissaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePermissaoResponse = factory(root.Pier.ApiClient, root.Pier.PermissaoResponse);
  }
}(this, function(ApiClient, PermissaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PagePermissaoResponse</code>.
   * {{{page_permissao_response_object_description}}}
   * @alias module:model/PagePermissaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePermissaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePermissaoResponse} obj Optional instance to populate.
   * @return {module:model/PagePermissaoResponse} The populated <code>PagePermissaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PermissaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PermissaoResponse>} content
   */

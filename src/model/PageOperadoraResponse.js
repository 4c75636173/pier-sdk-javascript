(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './OperadoraResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OperadoraResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageOperadoraResponse = factory(root.Pier.ApiClient, root.Pier.OperadoraResponse);
  }
}(this, function(ApiClient, OperadoraResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageOperadoraResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOperadoraResponse} obj Optional instance to populate.
   * @return {module:model/PageOperadoraResponse} The populated <code>PageOperadoraResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [OperadoraResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/OperadoraResponse>} content
   */

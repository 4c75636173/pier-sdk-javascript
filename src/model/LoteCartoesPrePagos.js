(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.LoteCartoesPrePagos = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>LoteCartoesPrePagos</code>.
   * Lote Cart\u00C3\u00B5es Pr\u00C3\u00A9-Pagos
   * @alias module:model/LoteCartoesPrePagos
   * @class
   * @param id
  ...
  /**
   * Constructs a <code>LoteCartoesPrePagos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LoteCartoesPrePagos} obj Optional instance to populate.
   * @return {module:model/LoteCartoesPrePagos} The populated <code>LoteCartoesPrePagos</code> instance.
   */

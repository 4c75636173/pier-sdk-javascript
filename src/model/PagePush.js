(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PagePush = factory(root.Pier.ApiClient, root.Pier.NotificacaoPushResponse);
  }
  ...
  /**
   * Constructs a new <code>PagePush</code>.
   * Lista de Push
   * @alias module:model/PagePush
   * @class
   */
  ...
  /**
   * Constructs a <code>PagePush</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePush} obj Optional instance to populate.
   * @return {module:model/PagePush} The populated <code>PagePush</code> instance.
   */

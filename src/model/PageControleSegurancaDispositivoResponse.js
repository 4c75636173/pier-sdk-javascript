(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ControleSegurancaDispositivoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ControleSegurancaDispositivoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageControleSegurancaDispositivoResponse = factory(root.Pier.ApiClient, root.Pier.ControleSegurancaDispositivoResponse);
  }
}(this, function(ApiClient, ControleSegurancaDispositivoResponse) {
  'use strict';

  /**
   * The PageControleSegurancaDispositivoResponse model module.
   * @module model/PageControleSegurancaDispositivoResponse
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageControleSegurancaDispositivoResponse</code>.
   * {{{page_controle_seguranca_dispositivo_resposta_descricao}}}
   * @alias module:model/PageControleSegurancaDispositivoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageControleSegurancaDispositivoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageControleSegurancaDispositivoResponse} obj Optional instance to populate.
   * @return {module:model/PageControleSegurancaDispositivoResponse} The populated <code>PageControleSegurancaDispositivoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ControleSegurancaDispositivoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ControleSegurancaDispositivoResponse>} content
   */

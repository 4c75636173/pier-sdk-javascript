(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ConvenioResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConvenioResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageConvenioResponse = factory(root.Pier.ApiClient, root.Pier.ConvenioResponse);
  }
}(this, function(ApiClient, ConvenioResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageConvenioResponse</code>.
   * Lista os dados banc\u00E1rios dos conv\u00EAnios existentes
   * @alias module:model/PageConvenioResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageConvenioResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageConvenioResponse} obj Optional instance to populate.
   * @return {module:model/PageConvenioResponse} The populated <code>PageConvenioResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ConvenioResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ConvenioResponse>} content
   */

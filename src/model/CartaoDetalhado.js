(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.CartaoDetalhado = factory(root.Pier.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CartaoDetalhado model module.
   * @module model/CartaoDetalhado
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>CartaoDetalhado</code>.
   * Objeto Cart\u00C3\u00A3o com mais informa\u00C3\u00A7\u00C3\u00B5es
   * @alias module:model/CartaoDetalhado
   * @class
   */
  ...
  /**
   * Constructs a <code>CartaoDetalhado</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CartaoDetalhado} obj Optional instance to populate.
   * @return {module:model/CartaoDetalhado} The populated <code>CartaoDetalhado</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusOportunidadeResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusOportunidadeResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusOprtunidades = factory(root.Pier.ApiClient, root.Pier.StatusOportunidadeResponse);
  }
}(this, function(ApiClient, StatusOportunidadeResponse) {
  'use strict';

  /**
   * The PageStatusOprtunidades model module.
   * @module model/PageStatusOprtunidades
   * @version 2.15.0
   */

  /**
   * Constructs a new <code>PageStatusOprtunidades</code>.
   * Lista de status oportunidades
   * @alias module:model/PageStatusOprtunidades
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStatusOprtunidades</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusOprtunidades} obj Optional instance to populate.
   * @return {module:model/PageStatusOprtunidades} The populated <code>PageStatusOprtunidades</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusOportunidadeResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusOportunidadeResponse>} content
   */

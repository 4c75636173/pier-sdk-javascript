(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TaxasRefinanciamentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TaxasRefinanciamentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTaxasRefinanciamentoResponse = factory(root.Pier.ApiClient, root.Pier.TaxasRefinanciamentoResponse);
  }
}(this, function(ApiClient, TaxasRefinanciamentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTaxasRefinanciamentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTaxasRefinanciamentoResponse} obj Optional instance to populate.
   * @return {module:model/PageTaxasRefinanciamentoResponse} The populated <code>PageTaxasRefinanciamentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TaxasRefinanciamentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TaxasRefinanciamentoResponse>} content
   */

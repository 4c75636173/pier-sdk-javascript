(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PortadorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PortadorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePortadorResponse = factory(root.Pier.ApiClient, root.Pier.PortadorResponse);
  }
}(this, function(ApiClient, PortadorResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PagePortadorResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePortadorResponse} obj Optional instance to populate.
   * @return {module:model/PagePortadorResponse} The populated <code>PagePortadorResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PortadorResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PortadorResponse>} content
   */

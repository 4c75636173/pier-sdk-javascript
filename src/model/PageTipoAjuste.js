(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoAjusteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoAjusteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoAjuste = factory(root.Pier.ApiClient, root.Pier.TipoAjusteResponse);
  }
}(this, function(ApiClient, TipoAjusteResponse) {
  'use strict';

  /**
   * The PageTipoAjuste model module.
   * @module model/PageTipoAjuste
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageTipoAjuste</code>.
   * Lista dos tipos de ajustes
   * @alias module:model/PageTipoAjuste
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoAjuste</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoAjuste} obj Optional instance to populate.
   * @return {module:model/PageTipoAjuste} The populated <code>PageTipoAjuste</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoAjusteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoAjusteResponse>} content
   */

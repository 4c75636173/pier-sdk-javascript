(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoArquivoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoArquivoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoArquivoResponse = factory(root.Pier.ApiClient, root.Pier.TipoArquivoResponse);
  }
}(this, function(ApiClient, TipoArquivoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoArquivoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoArquivoResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoArquivoResponse} The populated <code>PageTipoArquivoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoArquivoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoArquivoResponse>} content
   */

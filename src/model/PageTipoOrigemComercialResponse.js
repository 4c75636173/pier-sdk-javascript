(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoOrigemComercialResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoOrigemComercialResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoOrigemComercialResponse = factory(root.Pier.ApiClient, root.Pier.TipoOrigemComercialResponse);
  }
}(this, function(ApiClient, TipoOrigemComercialResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoOrigemComercialResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoOrigemComercialResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoOrigemComercialResponse} The populated <code>PageTipoOrigemComercialResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoOrigemComercialResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoOrigemComercialResponse>} content
   */

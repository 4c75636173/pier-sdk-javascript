(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TelefoneEstabelecimentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TelefoneEstabelecimentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTelefoneEstabelecimentoResponse = factory(root.Pier.ApiClient, root.Pier.TelefoneEstabelecimentoResponse);
  }
}(this, function(ApiClient, TelefoneEstabelecimentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTelefoneEstabelecimentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTelefoneEstabelecimentoResponse} obj Optional instance to populate.
   * @return {module:model/PageTelefoneEstabelecimentoResponse} The populated <code>PageTelefoneEstabelecimentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TelefoneEstabelecimentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TelefoneEstabelecimentoResponse>} content
   */

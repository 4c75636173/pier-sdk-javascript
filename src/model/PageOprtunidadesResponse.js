(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageOprtunidadesResponse = factory(root.Pier.ApiClient, root.Pier.OportunidadeResponse);
  }
}(this, function(ApiClient, OportunidadeResponse) {
  'use strict';

  /**
   * The PageOprtunidadesResponse model module.
   * @module model/PageOprtunidadesResponse
   * @version 2.15.0
   */

  /**
   * Constructs a new <code>PageOprtunidadesResponse</code>.
   * Lista de oportunidades
   * @alias module:model/PageOprtunidadesResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageOprtunidadesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOprtunidadesResponse} obj Optional instance to populate.
   * @return {module:model/PageOprtunidadesResponse} The populated <code>PageOprtunidadesResponse</code> instance.
   */

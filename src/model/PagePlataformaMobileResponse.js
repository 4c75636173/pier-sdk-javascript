(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PlataformaMobileResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PlataformaMobileResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePlataformaMobileResponse = factory(root.Pier.ApiClient, root.Pier.PlataformaMobileResponse);
  }
}(this, function(ApiClient, PlataformaMobileResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PagePlataformaMobileResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePlataformaMobileResponse} obj Optional instance to populate.
   * @return {module:model/PagePlataformaMobileResponse} The populated <code>PagePlataformaMobileResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PlataformaMobileResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PlataformaMobileResponse>} content
   */

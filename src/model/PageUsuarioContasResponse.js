(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './UsuarioContasResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UsuarioContasResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageUsuarioContasResponse = factory(root.Pier.ApiClient, root.Pier.UsuarioContasResponse);
  }
}(this, function(ApiClient, UsuarioContasResponse) {
  'use strict';

  /**
   * The PageUsuarioContasResponse model module.
   * @module model/PageUsuarioContasResponse
   * @version 2.74.2
   */

  /**
   * Constructs a new <code>PageUsuarioContasResponse</code>.
   * {{{page_usuario_conta_resposta_descricao}}}
   * @alias module:model/PageUsuarioContasResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageUsuarioContasResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageUsuarioContasResponse} obj Optional instance to populate.
   * @return {module:model/PageUsuarioContasResponse} The populated <code>PageUsuarioContasResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [UsuarioContasResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/UsuarioContasResponse>} content
   */

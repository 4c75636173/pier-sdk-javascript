(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './OperacaoCredorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OperacaoCredorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageOperacaoCredorResponse = factory(root.Pier.ApiClient, root.Pier.OperacaoCredorResponse);
  }
}(this, function(ApiClient, OperacaoCredorResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageOperacaoCredorResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOperacaoCredorResponse} obj Optional instance to populate.
   * @return {module:model/PageOperacaoCredorResponse} The populated <code>PageOperacaoCredorResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [OperacaoCredorResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/OperacaoCredorResponse>} content
   */

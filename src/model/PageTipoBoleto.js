(function(root, factory) {
  ...
  /**
   * Constructs a new <code>PageTipoBoleto</code>.
   * Lista dos tipos de boletos
   * @alias module:model/PageTipoBoleto
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoBoleto</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoBoleto} obj Optional instance to populate.
   * @return {module:model/PageTipoBoleto} The populated <code>PageTipoBoleto</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageStatusOportunidadeAUDResponse = factory(root.Pier.ApiClient, root.Pier.StatusOportunidadeAUDResponse);
  }
  ...
  /**
   * Constructs a <code>PageStatusOportunidadeAUDResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusOportunidadeAUDResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusOportunidadeAUDResponse} The populated <code>PageStatusOportunidadeAUDResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusConta'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusConta'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusContas = factory(root.Pier.ApiClient, root.Pier.StatusConta);
  }
}(this, function(ApiClient, StatusConta) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageStatusContas</code>.
   * Lista de Status Contas
   * @alias module:model/PageStatusContas
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStatusContas</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusContas} obj Optional instance to populate.
   * @return {module:model/PageStatusContas} The populated <code>PageStatusContas</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusConta]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusConta>} content
   */

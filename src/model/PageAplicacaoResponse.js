(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AplicacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AplicacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAplicacaoResponse = factory(root.Pier.ApiClient, root.Pier.AplicacaoResponse);
  }
}(this, function(ApiClient, AplicacaoResponse) {
  'use strict';

  /**
   * The PageAplicacaoResponse model module.
   * @module model/PageAplicacaoResponse
   * @version 2.74.2
   */

  /**
   * Constructs a new <code>PageAplicacaoResponse</code>.
   * {{{page_aplicacao_response_description}}}
   * @alias module:model/PageAplicacaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageAplicacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAplicacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageAplicacaoResponse} The populated <code>PageAplicacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AplicacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AplicacaoResponse>} content
   */

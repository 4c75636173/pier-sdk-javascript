(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TerminalResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TerminalResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTerminalResponse = factory(root.Pier.ApiClient, root.Pier.TerminalResponse);
  }
}(this, function(ApiClient, TerminalResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTerminalResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTerminalResponse} obj Optional instance to populate.
   * @return {module:model/PageTerminalResponse} The populated <code>PageTerminalResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TerminalResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TerminalResponse>} content
   */

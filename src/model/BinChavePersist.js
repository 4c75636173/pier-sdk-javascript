(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.BinChavePersist = factory(root.Pier.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The BinChavePersist model module.
   * @module model/BinChavePersist
   * @version 2.74.2
   */

  /**
   * Constructs a new <code>BinChavePersist</code>.
   * @alias module:model/BinChavePersist
   * @class
   */
  ...
  /**
   * Constructs a <code>BinChavePersist</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BinChavePersist} obj Optional instance to populate.
   * @return {module:model/BinChavePersist} The populated <code>BinChavePersist</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.AntecipacaoMockResponse = factory(root.Pier.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AntecipacaoMockResponse model module.
   * @module model/AntecipacaoMockResponse
   * @version 2.43.0
   */

  /**
   * Constructs a new <code>AntecipacaoMockResponse</code>.
   * @alias module:model/AntecipacaoMockResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AntecipacaoMockResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AntecipacaoMockResponse} obj Optional instance to populate.
   * @return {module:model/AntecipacaoMockResponse} The populated <code>AntecipacaoMockResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageContaDetalheResponse = factory(root.Pier.ApiClient, root.Pier.ContaDetalheResponse);
  }
  ...
  /**
   * Constructs a <code>PageContaDetalheResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContaDetalheResponse} obj Optional instance to populate.
   * @return {module:model/PageContaDetalheResponse} The populated <code>PageContaDetalheResponse</code> instance.
   */

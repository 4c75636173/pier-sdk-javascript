(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ContaDetalheResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContaDetalheResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageContasDetalhe = factory(root.Pier.ApiClient, root.Pier.ContaDetalheResponse);
  }
}(this, function(ApiClient, ContaDetalheResponse) {
  'use strict';

  /**
   * The PageContasDetalhe model module.
   * @module model/PageContasDetalhe
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageContasDetalhe</code>.
   * Lista detalhes contas
   * @alias module:model/PageContasDetalhe
   * @class
   */
  ...
  /**
   * Constructs a <code>PageContasDetalhe</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContasDetalhe} obj Optional instance to populate.
   * @return {module:model/PageContasDetalhe} The populated <code>PageContasDetalhe</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ContaDetalheResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ContaDetalheResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AplicacaoMobile'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AplicacaoMobile'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAplicacoesMobile = factory(root.Pier.ApiClient, root.Pier.AplicacaoMobile);
  }
}(this, function(ApiClient, AplicacaoMobile) {
  'use strict';

  /**
   * The PageAplicacoesMobile model module.
   * @module model/PageAplicacoesMobile
   * @version 2.15.5
   */

  /**
   * Constructs a new <code>PageAplicacoesMobile</code>.
   * Lista de Aplicacoes Mobile
   * @alias module:model/PageAplicacoesMobile
   * @class
   */
  ...
  /**
   * Constructs a <code>PageAplicacoesMobile</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAplicacoesMobile} obj Optional instance to populate.
   * @return {module:model/PageAplicacoesMobile} The populated <code>PageAplicacoesMobile</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AplicacaoMobile]);
      }
  ...
  /**
   * @member {Array.<module:model/AplicacaoMobile>} content
   */

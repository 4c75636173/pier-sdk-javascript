(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './JobResponse'], factory);
    ...
    root.Pier.PageJobResponse = factory(root.Pier.ApiClient, root.Pier.JobResponse);
  }
  ...
  /**
   * Constructs a <code>PageJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageJobResponse} obj Optional instance to populate.
   * @return {module:model/PageJobResponse} The populated <code>PageJobResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [JobResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/JobResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.AntecipacaoSimuladaMockResponse = factory(root.Pier.ApiClient, root.Pier.AntecipacaoSimuladaDetalhesResponse);
  }
}(this, function(ApiClient, AntecipacaoSimuladaDetalhesResponse) {
  'use strict';

  /**
   * The AntecipacaoSimuladaMockResponse model module.
   * @module model/AntecipacaoSimuladaMockResponse
   * @version 2.43.0
   */

  /**
   * Constructs a new <code>AntecipacaoSimuladaMockResponse</code>.
   * Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso Antecipacao Simulada
   * @alias module:model/AntecipacaoSimuladaMockResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AntecipacaoSimuladaMockResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AntecipacaoSimuladaMockResponse} obj Optional instance to populate.
   * @return {module:model/AntecipacaoSimuladaMockResponse} The populated <code>AntecipacaoSimuladaMockResponse</code> instance.
   */

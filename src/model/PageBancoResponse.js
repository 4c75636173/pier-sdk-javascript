(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './BancoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BancoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBancoResponse = factory(root.Pier.ApiClient, root.Pier.BancoResponse);
  }
}(this, function(ApiClient, BancoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageBancoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBancoResponse} obj Optional instance to populate.
   * @return {module:model/PageBancoResponse} The populated <code>PageBancoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BancoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/BancoResponse>} content
   */

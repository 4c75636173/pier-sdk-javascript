(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './GrupoChargebackResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GrupoChargebackResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageGrupoChargebackResponse = factory(root.Pier.ApiClient, root.Pier.GrupoChargebackResponse);
  }
}(this, function(ApiClient, GrupoChargebackResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageGrupoChargebackResponse</code>.
   * {{{page_grupo_chargeback_response_description}}}
   * @alias module:model/PageGrupoChargebackResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageGrupoChargebackResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageGrupoChargebackResponse} obj Optional instance to populate.
   * @return {module:model/PageGrupoChargebackResponse} The populated <code>PageGrupoChargebackResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [GrupoChargebackResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/GrupoChargebackResponse>} content
   */

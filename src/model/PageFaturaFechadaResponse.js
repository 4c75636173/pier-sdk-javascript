(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './FaturaFechadaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FaturaFechadaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageFaturaFechadaResponse = factory(root.Pier.ApiClient, root.Pier.FaturaFechadaResponse);
  }
}(this, function(ApiClient, FaturaFechadaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageFaturaFechadaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFaturaFechadaResponse} obj Optional instance to populate.
   * @return {module:model/PageFaturaFechadaResponse} The populated <code>PageFaturaFechadaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [FaturaFechadaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/FaturaFechadaResponse>} content
   */

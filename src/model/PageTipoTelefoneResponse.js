(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoTelefoneResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoTelefoneResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoTelefoneResponse = factory(root.Pier.ApiClient, root.Pier.TipoTelefoneResponse);
  }
}(this, function(ApiClient, TipoTelefoneResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoTelefoneResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoTelefoneResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoTelefoneResponse} The populated <code>PageTipoTelefoneResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoTelefoneResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoTelefoneResponse>} content
   */

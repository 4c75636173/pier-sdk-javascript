(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ContaHistoricoPagamentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContaHistoricoPagamentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageContaHistoricoPagamentoResponse = factory(root.Pier.ApiClient, root.Pier.ContaHistoricoPagamentoResponse);
  }
}(this, function(ApiClient, ContaHistoricoPagamentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageContaHistoricoPagamentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContaHistoricoPagamentoResponse} obj Optional instance to populate.
   * @return {module:model/PageContaHistoricoPagamentoResponse} The populated <code>PageContaHistoricoPagamentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ContaHistoricoPagamentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ContaHistoricoPagamentoResponse>} content
   */

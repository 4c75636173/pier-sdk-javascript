(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AvisoViagemResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AvisoViagemResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAvisoViagemResponse = factory(root.Pier.ApiClient, root.Pier.AvisoViagemResponse);
  }
}(this, function(ApiClient, AvisoViagemResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageAvisoViagemResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAvisoViagemResponse} obj Optional instance to populate.
   * @return {module:model/PageAvisoViagemResponse} The populated <code>PageAvisoViagemResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AvisoViagemResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AvisoViagemResponse>} content
   */

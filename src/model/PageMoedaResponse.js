(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './MoedaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MoedaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageMoedaResponse = factory(root.Pier.ApiClient, root.Pier.MoedaResponse);
  }
}(this, function(ApiClient, MoedaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageMoedaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageMoedaResponse} obj Optional instance to populate.
   * @return {module:model/PageMoedaResponse} The populated <code>PageMoedaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [MoedaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/MoedaResponse>} content
   */

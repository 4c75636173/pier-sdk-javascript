(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoEndereco'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoEndereco'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTiposEndereco = factory(root.Pier.ApiClient, root.Pier.TipoEndereco);
  }
}(this, function(ApiClient, TipoEndereco) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTiposEndereco</code>.
   * Lista de Tipos Endere\u00C3\u00A7o
   * @alias module:model/PageTiposEndereco
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTiposEndereco</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTiposEndereco} obj Optional instance to populate.
   * @return {module:model/PageTiposEndereco} The populated <code>PageTiposEndereco</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoEndereco]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoEndereco>} content
   */

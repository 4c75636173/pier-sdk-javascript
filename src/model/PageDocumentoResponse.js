(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './DocumentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DocumentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageDocumentoResponse = factory(root.Pier.ApiClient, root.Pier.DocumentoResponse);
  }
}(this, function(ApiClient, DocumentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageDocumentoResponse</code>.
   * Lista documento
   * @alias module:model/PageDocumentoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageDocumentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDocumentoResponse} obj Optional instance to populate.
   * @return {module:model/PageDocumentoResponse} The populated <code>PageDocumentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [DocumentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/DocumentoResponse>} content
   */

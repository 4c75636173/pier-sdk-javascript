(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Terminal'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Terminal'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTerminal = factory(root.Pier.ApiClient, root.Pier.Terminal);
  }
}(this, function(ApiClient, Terminal) {
  'use strict';

  /**
   * The PageTerminal model module.
   * @module model/PageTerminal
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageTerminal</code>.
   * Lista de terminais
   * @alias module:model/PageTerminal
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTerminal</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTerminal} obj Optional instance to populate.
   * @return {module:model/PageTerminal} The populated <code>PageTerminal</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Terminal]);
      }
  ...
  /**
   * @member {Array.<module:model/Terminal>} content
   */

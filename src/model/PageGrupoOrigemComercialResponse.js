(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './GrupoOrigemComercialResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GrupoOrigemComercialResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageGrupoOrigemComercialResponse = factory(root.Pier.ApiClient, root.Pier.GrupoOrigemComercialResponse);
  }
}(this, function(ApiClient, GrupoOrigemComercialResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageGrupoOrigemComercialResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageGrupoOrigemComercialResponse} obj Optional instance to populate.
   * @return {module:model/PageGrupoOrigemComercialResponse} The populated <code>PageGrupoOrigemComercialResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [GrupoOrigemComercialResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/GrupoOrigemComercialResponse>} content
   */

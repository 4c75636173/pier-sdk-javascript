(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './HistoricoAtrasoFaturaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HistoricoAtrasoFaturaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageHistoricoAtraso = factory(root.Pier.ApiClient, root.Pier.HistoricoAtrasoFaturaResponse);
  }
}(this, function(ApiClient, HistoricoAtrasoFaturaResponse) {
  'use strict';

  /**
   * The PageHistoricoAtraso model module.
   * @module model/PageHistoricoAtraso
   * @version 2.12.0
   */

  /**
   * Constructs a new <code>PageHistoricoAtraso</code>.
   * Lista historicos atraso pagamento
   * @alias module:model/PageHistoricoAtraso
   * @class
   */
  ...
  /**
   * Constructs a <code>PageHistoricoAtraso</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageHistoricoAtraso} obj Optional instance to populate.
   * @return {module:model/PageHistoricoAtraso} The populated <code>PageHistoricoAtraso</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [HistoricoAtrasoFaturaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/HistoricoAtrasoFaturaResponse>} content
   */

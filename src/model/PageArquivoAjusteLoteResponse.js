(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ArquivoAjusteLoteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ArquivoAjusteLoteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageArquivoAjusteLoteResponse = factory(root.Pier.ApiClient, root.Pier.ArquivoAjusteLoteResponse);
  }
}(this, function(ApiClient, ArquivoAjusteLoteResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageArquivoAjusteLoteResponse</code>.
   * {{{page_arquivo_ajuste_lote_response_description}}}
   * @alias module:model/PageArquivoAjusteLoteResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageArquivoAjusteLoteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageArquivoAjusteLoteResponse} obj Optional instance to populate.
   * @return {module:model/PageArquivoAjusteLoteResponse} The populated <code>PageArquivoAjusteLoteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ArquivoAjusteLoteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ArquivoAjusteLoteResponse>} content
   */

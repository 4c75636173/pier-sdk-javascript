(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CompraResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CompraResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCompras = factory(root.Pier.ApiClient, root.Pier.CompraResponse);
  }
}(this, function(ApiClient, CompraResponse) {
  'use strict';

  /**
   * The PageCompras model module.
   * @module model/PageCompras
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageCompras</code>.
   * Lista de compras
   * @alias module:model/PageCompras
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCompras</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCompras} obj Optional instance to populate.
   * @return {module:model/PageCompras} The populated <code>PageCompras</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CompraResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CompraResponse>} content
   */

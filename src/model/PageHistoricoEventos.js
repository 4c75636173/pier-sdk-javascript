(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './HistoricoEventos'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HistoricoEventos'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageHistoricoEventos = factory(root.Pier.ApiClient, root.Pier.HistoricoEventos);
  }
}(this, function(ApiClient, HistoricoEventos) {
  'use strict';

  /**
   * The PageHistoricoEventos model module.
   * @module model/PageHistoricoEventos
   * @version 2.13.0
   */

  /**
   * Constructs a new <code>PageHistoricoEventos</code>.
   * Lista de historivoEventos
   * @alias module:model/PageHistoricoEventos
   * @class
   */
  ...
  /**
   * Constructs a <code>PageHistoricoEventos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageHistoricoEventos} obj Optional instance to populate.
   * @return {module:model/PageHistoricoEventos} The populated <code>PageHistoricoEventos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [HistoricoEventos]);
      }
  ...
  /**
   * @member {Array.<module:model/HistoricoEventos>} content
   */

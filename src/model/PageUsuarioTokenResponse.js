(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './UsuarioTokenResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UsuarioTokenResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageUsuarioTokenResponse = factory(root.Pier.ApiClient, root.Pier.UsuarioTokenResponse);
  }
}(this, function(ApiClient, UsuarioTokenResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageUsuarioTokenResponse</code>.
   * {{{page_usuario_token_resposta_descricao}}}
   * @alias module:model/PageUsuarioTokenResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageUsuarioTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageUsuarioTokenResponse} obj Optional instance to populate.
   * @return {module:model/PageUsuarioTokenResponse} The populated <code>PageUsuarioTokenResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [UsuarioTokenResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/UsuarioTokenResponse>} content
   */

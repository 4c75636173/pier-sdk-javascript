(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TokenResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TokenResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTokenResponse = factory(root.Pier.ApiClient, root.Pier.TokenResponse);
  }
}(this, function(ApiClient, TokenResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTokenResponse</code>.
   * {{{page_token_response_description}}}
   * @alias module:model/PageTokenResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTokenResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTokenResponse} obj Optional instance to populate.
   * @return {module:model/PageTokenResponse} The populated <code>PageTokenResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TokenResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TokenResponse>} content
   */

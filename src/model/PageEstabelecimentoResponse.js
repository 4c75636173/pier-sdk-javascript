(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './EstabelecimentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EstabelecimentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageEstabelecimentoResponse = factory(root.Pier.ApiClient, root.Pier.EstabelecimentoResponse);
  }
}(this, function(ApiClient, EstabelecimentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageEstabelecimentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageEstabelecimentoResponse} obj Optional instance to populate.
   * @return {module:model/PageEstabelecimentoResponse} The populated <code>PageEstabelecimentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [EstabelecimentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/EstabelecimentoResponse>} content
   */

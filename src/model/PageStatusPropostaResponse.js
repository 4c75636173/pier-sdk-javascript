(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusPropostaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusPropostaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusPropostaResponse = factory(root.Pier.ApiClient, root.Pier.StatusPropostaResponse);
  }
}(this, function(ApiClient, StatusPropostaResponse) {
  'use strict';

  /**
   * The PageStatusPropostaResponse model module.
   * @module model/PageStatusPropostaResponse
   * @version 2.66.1
   */

  /**
   * Constructs a new <code>PageStatusPropostaResponse</code>.
   * {{{page_status_proposta_listar_response_description}}}
   * @alias module:model/PageStatusPropostaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStatusPropostaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusPropostaResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusPropostaResponse} The populated <code>PageStatusPropostaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusPropostaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusPropostaResponse>} content
   */

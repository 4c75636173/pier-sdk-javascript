(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageUsuarioResponse = factory(root.Pier.ApiClient, root.Pier.UsuarioResponse);
  }
  ...
  /**
   * Constructs a <code>PageUsuarioResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageUsuarioResponse} obj Optional instance to populate.
   * @return {module:model/PageUsuarioResponse} The populated <code>PageUsuarioResponse</code> instance.
   */

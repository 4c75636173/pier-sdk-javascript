(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoTerminalResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoTerminalResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoTerminalResponse = factory(root.Pier.ApiClient, root.Pier.TipoTerminalResponse);
  }
}(this, function(ApiClient, TipoTerminalResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoTerminalResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoTerminalResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoTerminalResponse} The populated <code>PageTipoTerminalResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoTerminalResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoTerminalResponse>} content
   */

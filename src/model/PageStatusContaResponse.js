(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusContaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusContaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusContaResponse = factory(root.Pier.ApiClient, root.Pier.StatusContaResponse);
  }
}(this, function(ApiClient, StatusContaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageStatusContaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusContaResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusContaResponse} The populated <code>PageStatusContaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusContaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusContaResponse>} content
   */

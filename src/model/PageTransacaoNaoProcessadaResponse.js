(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransacaoNaoProcessadaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransacaoNaoProcessadaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransacaoNaoProcessadaResponse = factory(root.Pier.ApiClient, root.Pier.TransacaoNaoProcessadaResponse);
  }
}(this, function(ApiClient, TransacaoNaoProcessadaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTransacaoNaoProcessadaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransacaoNaoProcessadaResponse} obj Optional instance to populate.
   * @return {module:model/PageTransacaoNaoProcessadaResponse} The populated <code>PageTransacaoNaoProcessadaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransacaoNaoProcessadaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TransacaoNaoProcessadaResponse>} content
   */

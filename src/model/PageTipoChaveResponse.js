(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoChaveResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoChaveResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoChaveResponse = factory(root.Pier.ApiClient, root.Pier.TipoChaveResponse);
  }
}(this, function(ApiClient, TipoChaveResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTipoChaveResponse</code>.
   * {{{page_tipo_chave_response_description}}}
   * @alias module:model/PageTipoChaveResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoChaveResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoChaveResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoChaveResponse} The populated <code>PageTipoChaveResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoChaveResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoChaveResponse>} content
   */

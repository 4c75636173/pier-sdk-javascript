(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './BaseResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BaseResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBaseResponse = factory(root.Pier.ApiClient, root.Pier.BaseResponse);
  }
}(this, function(ApiClient, BaseResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageBaseResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBaseResponse} obj Optional instance to populate.
   * @return {module:model/PageBaseResponse} The populated <code>PageBaseResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BaseResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/BaseResponse>} content
   */

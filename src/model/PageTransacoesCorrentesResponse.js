(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransacoesCorrentesResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransacoesCorrentesResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransacoesCorrentesResponse = factory(root.Pier.ApiClient, root.Pier.TransacoesCorrentesResponse);
  }
}(this, function(ApiClient, TransacoesCorrentesResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTransacoesCorrentesResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransacoesCorrentesResponse} obj Optional instance to populate.
   * @return {module:model/PageTransacoesCorrentesResponse} The populated <code>PageTransacoesCorrentesResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransacoesCorrentesResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TransacoesCorrentesResponse>} content
   */

(function(root, factory) {
  ...
  /**
   * Constructs a new <code>TransacoesCorrentes</code>.
   * Objeto transacoes correntes
   * @alias module:model/TransacoesCorrentes
   * @class
   */
  ...
  /**
   * Constructs a <code>TransacoesCorrentes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TransacoesCorrentes} obj Optional instance to populate.
   * @return {module:model/TransacoesCorrentes} The populated <code>TransacoesCorrentes</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.DividaClienteResponse = factory(root.Pier.ApiClient, root.Pier.ModelDate);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('dataVencimentoFaturaAtraso')) {
        obj['dataVencimentoFaturaAtraso'] = ApiClient.convertToType(data['dataVencimentoFaturaAtraso'], ModelDate);
      }
      ...
      if (data.hasOwnProperty('dataVencimentoAcordo')) {
        obj['dataVencimentoAcordo'] = ApiClient.convertToType(data['dataVencimentoAcordo'], ModelDate);
      }
   ...
   * @member {module:model/ModelDate} dataVencimentoFaturaAtraso
   */
   ...
   * @member {module:model/ModelDate} dataVencimentoAcordo
   */

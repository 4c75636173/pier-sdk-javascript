(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './FaturaConsignadaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FaturaConsignadaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageFaturasConsignadas = factory(root.Pier.ApiClient, root.Pier.FaturaConsignadaResponse);
  }
}(this, function(ApiClient, FaturaConsignadaResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageFaturasConsignadas</code>.
   * Lista de faturas
   * @alias module:model/PageFaturasConsignadas
   * @class
   */
  ...
  /**
   * Constructs a <code>PageFaturasConsignadas</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFaturasConsignadas} obj Optional instance to populate.
   * @return {module:model/PageFaturasConsignadas} The populated <code>PageFaturasConsignadas</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [FaturaConsignadaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/FaturaConsignadaResponse>} content
   */

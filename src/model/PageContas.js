(function(root, factory) {
  ...
  /**
   * Constructs a new <code>PageContas</code>.
   * Lista de contas
   * @alias module:model/PageContas
   * @class
   */
  ...
  /**
   * Constructs a <code>PageContas</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContas} obj Optional instance to populate.
   * @return {module:model/PageContas} The populated <code>PageContas</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './OrigemComercialResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OrigemComercialResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageOrigemComercialResponse = factory(root.Pier.ApiClient, root.Pier.OrigemComercialResponse);
  }
}(this, function(ApiClient, OrigemComercialResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageOrigemComercialResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageOrigemComercialResponse} obj Optional instance to populate.
   * @return {module:model/PageOrigemComercialResponse} The populated <code>PageOrigemComercialResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [OrigemComercialResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/OrigemComercialResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransacoesCorrentes'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransacoesCorrentes'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransacoesCorrentes = factory(root.Pier.ApiClient, root.Pier.TransacoesCorrentes);
  }
}(this, function(ApiClient, TransacoesCorrentes) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTransacoesCorrentes</code>.
   * Lista de Transa\u00C3\u00A7\u00C3\u00B5es Correntes
   * @alias module:model/PageTransacoesCorrentes
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTransacoesCorrentes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransacoesCorrentes} obj Optional instance to populate.
   * @return {module:model/PageTransacoesCorrentes} The populated <code>PageTransacoesCorrentes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransacoesCorrentes]);
      }
  ...
  /**
   * @member {Array.<module:model/TransacoesCorrentes>} content
   */

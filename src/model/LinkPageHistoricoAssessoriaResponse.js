(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './LinkHistoricoAssessoriaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LinkHistoricoAssessoriaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.LinkPageHistoricoAssessoriaResponse = factory(root.Pier.ApiClient, root.Pier.LinkHistoricoAssessoriaResponse);
  }
}(this, function(ApiClient, LinkHistoricoAssessoriaResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>LinkPageHistoricoAssessoriaResponse</code>.
   * Lista de Historicos Assessorias
   * @alias module:model/LinkPageHistoricoAssessoriaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>LinkPageHistoricoAssessoriaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LinkPageHistoricoAssessoriaResponse} obj Optional instance to populate.
   * @return {module:model/LinkPageHistoricoAssessoriaResponse} The populated <code>LinkPageHistoricoAssessoriaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [LinkHistoricoAssessoriaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/LinkHistoricoAssessoriaResponse>} content
   */

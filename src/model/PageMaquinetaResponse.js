(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './MaquinetaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./MaquinetaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageMaquinetaResponse = factory(root.Pier.ApiClient, root.Pier.MaquinetaResponse);
  }
}(this, function(ApiClient, MaquinetaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageMaquinetaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageMaquinetaResponse} obj Optional instance to populate.
   * @return {module:model/PageMaquinetaResponse} The populated <code>PageMaquinetaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [MaquinetaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/MaquinetaResponse>} content
   */

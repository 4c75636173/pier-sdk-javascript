(function(root, factory) {
  ...
  /**
   * Constructs a <code>PagePushResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePushResponse} obj Optional instance to populate.
   * @return {module:model/PagePushResponse} The populated <code>PagePushResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageProdutoResponse = factory(root.Pier.ApiClient, root.Pier.ProdutoResponse);
  }
  ...
  /**
   * Constructs a new <code>PageProdutoResponse</code>.
   * Lista de Produtos
   * @alias module:model/PageProdutoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageProdutoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageProdutoResponse} obj Optional instance to populate.
   * @return {module:model/PageProdutoResponse} The populated <code>PageProdutoResponse</code> instance.
   */

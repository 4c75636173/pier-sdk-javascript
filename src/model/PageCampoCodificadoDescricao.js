(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CampoCodificadoDescricaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CampoCodificadoDescricaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCampoCodificadoDescricao = factory(root.Pier.ApiClient, root.Pier.CampoCodificadoDescricaoResponse);
  }
}(this, function(ApiClient, CampoCodificadoDescricaoResponse) {
  'use strict';

  /**
   * The PageCampoCodificadoDescricao model module.
   * @module model/PageCampoCodificadoDescricao
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageCampoCodificadoDescricao</code>.
   * Lista de Campos Codificados
   * @alias module:model/PageCampoCodificadoDescricao
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCampoCodificadoDescricao</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCampoCodificadoDescricao} obj Optional instance to populate.
   * @return {module:model/PageCampoCodificadoDescricao} The populated <code>PageCampoCodificadoDescricao</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CampoCodificadoDescricaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CampoCodificadoDescricaoResponse>} content
   */

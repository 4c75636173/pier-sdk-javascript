(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './FantasiaBasicaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FantasiaBasicaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageFantasiaBasicaResponse = factory(root.Pier.ApiClient, root.Pier.FantasiaBasicaResponse);
  }
}(this, function(ApiClient, FantasiaBasicaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageFantasiaBasicaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFantasiaBasicaResponse} obj Optional instance to populate.
   * @return {module:model/PageFantasiaBasicaResponse} The populated <code>PageFantasiaBasicaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [FantasiaBasicaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/FantasiaBasicaResponse>} content
   */

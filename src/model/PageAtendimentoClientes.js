(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AtendimentoCliente'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AtendimentoCliente'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAtendimentoClientes = factory(root.Pier.ApiClient, root.Pier.AtendimentoCliente);
  }
}(this, function(ApiClient, AtendimentoCliente) {
  'use strict';

  /**
   * The PageAtendimentoClientes model module.
   * @module model/PageAtendimentoClientes
   * @version 2.6.1
   */

  /**
   * Constructs a new <code>PageAtendimentoClientes</code>.
   * Lista atendimento clientes
   * @alias module:model/PageAtendimentoClientes
   * @class
   */
  ...
  /**
   * Constructs a <code>PageAtendimentoClientes</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAtendimentoClientes} obj Optional instance to populate.
   * @return {module:model/PageAtendimentoClientes} The populated <code>PageAtendimentoClientes</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AtendimentoCliente]);
      }
  ...
  /**
   * @member {Array.<module:model/AtendimentoCliente>} content
   */

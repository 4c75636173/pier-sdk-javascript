(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './DetalheAjusteLoteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DetalheAjusteLoteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageDetalheAjusteLoteResponse = factory(root.Pier.ApiClient, root.Pier.DetalheAjusteLoteResponse);
  }
}(this, function(ApiClient, DetalheAjusteLoteResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageDetalheAjusteLoteResponse</code>.
   * {{{page_detalhe_ajuste_lote_response_description}}}
   * @alias module:model/PageDetalheAjusteLoteResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageDetalheAjusteLoteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDetalheAjusteLoteResponse} obj Optional instance to populate.
   * @return {module:model/PageDetalheAjusteLoteResponse} The populated <code>PageDetalheAjusteLoteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [DetalheAjusteLoteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/DetalheAjusteLoteResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.AplicacaoMobile = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>AplicacaoMobile</code>.
   * Aplicacao Mobile
   * @alias module:model/AplicacaoMobile
   * @class
   */
  ...
  /**
   * Constructs a <code>AplicacaoMobile</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AplicacaoMobile} obj Optional instance to populate.
   * @return {module:model/AplicacaoMobile} The populated <code>AplicacaoMobile</code> instance.
   */

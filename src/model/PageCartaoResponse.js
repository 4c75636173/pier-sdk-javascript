(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageCartaoResponse = factory(root.Pier.ApiClient, root.Pier.CartaoResponse);
  }
  ...
  /**
   * Constructs a <code>PageCartaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCartaoResponse} obj Optional instance to populate.
   * @return {module:model/PageCartaoResponse} The populated <code>PageCartaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CartaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CartaoResponse>} content
   */

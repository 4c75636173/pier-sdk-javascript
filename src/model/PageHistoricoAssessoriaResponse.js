(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './HistoricoAssessoriaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./HistoricoAssessoriaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageHistoricoAssessoriaResponse = factory(root.Pier.ApiClient, root.Pier.HistoricoAssessoriaResponse);
  }
}(this, function(ApiClient, HistoricoAssessoriaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageHistoricoAssessoriaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageHistoricoAssessoriaResponse} obj Optional instance to populate.
   * @return {module:model/PageHistoricoAssessoriaResponse} The populated <code>PageHistoricoAssessoriaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [HistoricoAssessoriaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/HistoricoAssessoriaResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AplicacaoMobileResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AplicacaoMobileResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAplicacaoMobileResponse = factory(root.Pier.ApiClient, root.Pier.AplicacaoMobileResponse);
  }
}(this, function(ApiClient, AplicacaoMobileResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageAplicacaoMobileResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAplicacaoMobileResponse} obj Optional instance to populate.
   * @return {module:model/PageAplicacaoMobileResponse} The populated <code>PageAplicacaoMobileResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AplicacaoMobileResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AplicacaoMobileResponse>} content
   */

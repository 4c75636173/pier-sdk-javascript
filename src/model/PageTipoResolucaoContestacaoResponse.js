(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CdtTipoResolucaoContestacao'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CdtTipoResolucaoContestacao'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoResolucaoContestacaoResponse = factory(root.Pier.ApiClient, root.Pier.CdtTipoResolucaoContestacao);
  }
}(this, function(ApiClient, CdtTipoResolucaoContestacao) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTipoResolucaoContestacaoResponse</code>.
   * {{{page_tipo_resolucao_contestacao_response_description}}}
   * @alias module:model/PageTipoResolucaoContestacaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoResolucaoContestacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoResolucaoContestacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoResolucaoContestacaoResponse} The populated <code>PageTipoResolucaoContestacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CdtTipoResolucaoContestacao]);
      }
  ...
  /**
   * @member {Array.<module:model/CdtTipoResolucaoContestacao>} content
   */

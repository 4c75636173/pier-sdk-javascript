(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './EstagioCartaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EstagioCartaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageEstagioCartaoResponse = factory(root.Pier.ApiClient, root.Pier.EstagioCartaoResponse);
  }
}(this, function(ApiClient, EstagioCartaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageEstagioCartaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageEstagioCartaoResponse} obj Optional instance to populate.
   * @return {module:model/PageEstagioCartaoResponse} The populated <code>PageEstagioCartaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [EstagioCartaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/EstagioCartaoResponse>} content
   */

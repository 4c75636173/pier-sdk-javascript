(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoOportunidadeResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoOportunidadeResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoOprtunidades = factory(root.Pier.ApiClient, root.Pier.TipoOportunidadeResponse);
  }
}(this, function(ApiClient, TipoOportunidadeResponse) {
  'use strict';

  /**
   * The PageTipoOprtunidades model module.
   * @module model/PageTipoOprtunidades
   * @version 2.12.0
   */

  /**
   * Constructs a new <code>PageTipoOprtunidades</code>.
   * Lista de tipos oportunidades
   * @alias module:model/PageTipoOprtunidades
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoOprtunidades</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoOprtunidades} obj Optional instance to populate.
   * @return {module:model/PageTipoOprtunidades} The populated <code>PageTipoOprtunidades</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoOportunidadeResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoOportunidadeResponse>} content
   */

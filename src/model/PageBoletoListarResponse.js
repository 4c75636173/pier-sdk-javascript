(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './BoletoListarResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BoletoListarResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBoletoListarResponse = factory(root.Pier.ApiClient, root.Pier.BoletoListarResponse);
  }
}(this, function(ApiClient, BoletoListarResponse) {
  'use strict';

  /**
   * The PageBoletoListarResponse model module.
   * @module model/PageBoletoListarResponse
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageBoletoListarResponse</code>.
   * {{{page_boleto_listar_response_description}}}
   * @alias module:model/PageBoletoListarResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageBoletoListarResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBoletoListarResponse} obj Optional instance to populate.
   * @return {module:model/PageBoletoListarResponse} The populated <code>PageBoletoListarResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BoletoListarResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/BoletoListarResponse>} content
   */

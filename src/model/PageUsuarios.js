(function(root, factory) {
  ...
  /**
   * Constructs a new <code>PageUsuarios</code>.
   * Lista de Usu\u00C3\u00A1rios
   * @alias module:model/PageUsuarios
   * @class
   */
  ...
  /**
   * Constructs a <code>PageUsuarios</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageUsuarios} obj Optional instance to populate.
   * @return {module:model/PageUsuarios} The populated <code>PageUsuarios</code> instance.
   */

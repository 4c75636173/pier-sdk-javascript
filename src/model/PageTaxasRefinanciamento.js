(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TaxasRefinanciamento'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TaxasRefinanciamento'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTaxasRefinanciamento = factory(root.Pier.ApiClient, root.Pier.TaxasRefinanciamento);
  }
}(this, function(ApiClient, TaxasRefinanciamento) {
  'use strict';

  /**
   * The PageTaxasRefinanciamento model module.
   * @module model/PageTaxasRefinanciamento
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageTaxasRefinanciamento</code>.
   * Lista das taxas e tarifas
   * @alias module:model/PageTaxasRefinanciamento
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTaxasRefinanciamento</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTaxasRefinanciamento} obj Optional instance to populate.
   * @return {module:model/PageTaxasRefinanciamento} The populated <code>PageTaxasRefinanciamento</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TaxasRefinanciamento]);
      }
  ...
  /**
   * @member {Array.<module:model/TaxasRefinanciamento>} content
   */

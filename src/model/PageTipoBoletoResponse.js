(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoBoletoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoBoletoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoBoletoResponse = factory(root.Pier.ApiClient, root.Pier.TipoBoletoResponse);
  }
}(this, function(ApiClient, TipoBoletoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoBoletoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoBoletoResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoBoletoResponse} The populated <code>PageTipoBoletoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoBoletoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoBoletoResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransferenciaCreditoContaBancariaListaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransferenciaCreditoContaBancariaListaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransferenciaCreditoContaBancariaResponse = factory(root.Pier.ApiClient, root.Pier.TransferenciaCreditoContaBancariaListaResponse);
  }
}(this, function(ApiClient, TransferenciaCreditoContaBancariaListaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTransferenciaCreditoContaBancariaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransferenciaCreditoContaBancariaResponse} obj Optional instance to populate.
   * @return {module:model/PageTransferenciaCreditoContaBancariaResponse} The populated <code>PageTransferenciaCreditoContaBancariaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransferenciaCreditoContaBancariaListaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TransferenciaCreditoContaBancariaListaResponse>} content
   */

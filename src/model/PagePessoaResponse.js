(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PessoaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PessoaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePessoaResponse = factory(root.Pier.ApiClient, root.Pier.PessoaResponse);
  }
}(this, function(ApiClient, PessoaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PagePessoaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePessoaResponse} obj Optional instance to populate.
   * @return {module:model/PagePessoaResponse} The populated <code>PagePessoaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PessoaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PessoaResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './VinculoOperacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./VinculoOperacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageVinculoOperacaoResponse = factory(root.Pier.ApiClient, root.Pier.VinculoOperacaoResponse);
  }
}(this, function(ApiClient, VinculoOperacaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageVinculoOperacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageVinculoOperacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageVinculoOperacaoResponse} The populated <code>PageVinculoOperacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [VinculoOperacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/VinculoOperacaoResponse>} content
   */

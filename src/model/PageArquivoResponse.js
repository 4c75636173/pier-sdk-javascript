(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ArquivoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ArquivoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageArquivoResponse = factory(root.Pier.ApiClient, root.Pier.ArquivoResponse);
  }
}(this, function(ApiClient, ArquivoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageArquivoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageArquivoResponse} obj Optional instance to populate.
   * @return {module:model/PageArquivoResponse} The populated <code>PageArquivoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ArquivoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ArquivoResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageCompraResponse = factory(root.Pier.ApiClient, root.Pier.CompraResponse);
  }
  ...
  /**
   * Constructs a new <code>PageCompraResponse</code>.
   * Lista de compras
   * @alias module:model/PageCompraResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCompraResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCompraResponse} obj Optional instance to populate.
   * @return {module:model/PageCompraResponse} The populated <code>PageCompraResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TransferenciaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TransferenciaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransferenciaResponse = factory(root.Pier.ApiClient, root.Pier.TransferenciaResponse);
  }
}(this, function(ApiClient, TransferenciaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTransferenciaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransferenciaResponse} obj Optional instance to populate.
   * @return {module:model/PageTransferenciaResponse} The populated <code>PageTransferenciaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TransferenciaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TransferenciaResponse>} content
   */

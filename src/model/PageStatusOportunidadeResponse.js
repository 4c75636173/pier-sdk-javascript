(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageStatusOportunidadeResponse = factory(root.Pier.ApiClient, root.Pier.StatusOportunidadeResponse);
  }
  ...
  /**
   * Constructs a <code>PageStatusOportunidadeResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusOportunidadeResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusOportunidadeResponse} The populated <code>PageStatusOportunidadeResponse</code> instance.
   */

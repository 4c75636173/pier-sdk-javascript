(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './WebHook'], factory);
    ...
    root.Pier.PageWebHooks = factory(root.Pier.ApiClient, root.Pier.WebHook);
  }
  ...
  /**
   * Constructs a new <code>PageWebHooks</code>.
   * Lista de WebHooks
   * @alias module:model/PageWebHooks
   * @class
   */
  ...
  /**
   * Constructs a <code>PageWebHooks</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageWebHooks} obj Optional instance to populate.
   * @return {module:model/PageWebHooks} The populated <code>PageWebHooks</code> instance.
   */

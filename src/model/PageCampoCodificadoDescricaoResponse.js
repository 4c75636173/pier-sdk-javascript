(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageCampoCodificadoDescricaoResponse = factory(root.Pier.ApiClient, root.Pier.CampoCodificadoDescricaoResponse);
  }
  ...
  /**
   * Constructs a new <code>PageCampoCodificadoDescricaoResponse</code>.
   * Lista de Campos Codificados
   * @alias module:model/PageCampoCodificadoDescricaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageCampoCodificadoDescricaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCampoCodificadoDescricaoResponse} obj Optional instance to populate.
   * @return {module:model/PageCampoCodificadoDescricaoResponse} The populated <code>PageCampoCodificadoDescricaoResponse</code> instance.
   */

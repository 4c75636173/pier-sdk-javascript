(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './PromotorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PromotorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PagePromotorResponse = factory(root.Pier.ApiClient, root.Pier.PromotorResponse);
  }
}(this, function(ApiClient, PromotorResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PagePromotorResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PagePromotorResponse} obj Optional instance to populate.
   * @return {module:model/PagePromotorResponse} The populated <code>PagePromotorResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [PromotorResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/PromotorResponse>} content
   */

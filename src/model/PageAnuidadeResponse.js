(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AnuidadeResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AnuidadeResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAnuidadeResponse = factory(root.Pier.ApiClient, root.Pier.AnuidadeResponse);
  }
}(this, function(ApiClient, AnuidadeResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageAnuidadeResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAnuidadeResponse} obj Optional instance to populate.
   * @return {module:model/PageAnuidadeResponse} The populated <code>PageAnuidadeResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AnuidadeResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AnuidadeResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoCampanhaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoCampanhaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoCampanhaResponse = factory(root.Pier.ApiClient, root.Pier.TipoCampanhaResponse);
  }
}(this, function(ApiClient, TipoCampanhaResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTipoCampanhaResponse</code>.
   * Representa\u00C3\u00A7\u00C3\u00A3o da resposta do recurso de tipo de campanha
   * @alias module:model/PageTipoCampanhaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoCampanhaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoCampanhaResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoCampanhaResponse} The populated <code>PageTipoCampanhaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoCampanhaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoCampanhaResponse>} content
   */

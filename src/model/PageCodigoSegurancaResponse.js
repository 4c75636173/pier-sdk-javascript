(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './CodigoSegurancaResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CodigoSegurancaResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageCodigoSegurancaResponse = factory(root.Pier.ApiClient, root.Pier.CodigoSegurancaResponse);
  }
}(this, function(ApiClient, CodigoSegurancaResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageCodigoSegurancaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageCodigoSegurancaResponse} obj Optional instance to populate.
   * @return {module:model/PageCodigoSegurancaResponse} The populated <code>PageCodigoSegurancaResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [CodigoSegurancaResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/CodigoSegurancaResponse>} content
   */

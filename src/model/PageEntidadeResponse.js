(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './EntidadeResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EntidadeResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageEntidadeResponse = factory(root.Pier.ApiClient, root.Pier.EntidadeResponse);
  }
}(this, function(ApiClient, EntidadeResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageEntidadeResponse</code>.
   * Lista as Entidades
   * @alias module:model/PageEntidadeResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageEntidadeResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageEntidadeResponse} obj Optional instance to populate.
   * @return {module:model/PageEntidadeResponse} The populated <code>PageEntidadeResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [EntidadeResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/EntidadeResponse>} content
   */

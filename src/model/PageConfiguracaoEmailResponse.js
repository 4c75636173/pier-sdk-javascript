(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ConfiguracaoEmailResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConfiguracaoEmailResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageConfiguracaoEmailResponse = factory(root.Pier.ApiClient, root.Pier.ConfiguracaoEmailResponse);
  }
}(this, function(ApiClient, ConfiguracaoEmailResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageConfiguracaoEmailResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageConfiguracaoEmailResponse} obj Optional instance to populate.
   * @return {module:model/PageConfiguracaoEmailResponse} The populated <code>PageConfiguracaoEmailResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ConfiguracaoEmailResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ConfiguracaoEmailResponse>} content
   */

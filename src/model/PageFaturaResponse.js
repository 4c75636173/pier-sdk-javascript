(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageFaturaResponse = factory(root.Pier.ApiClient, root.Pier.FaturaResponse);
  }
  ...
  /**
   * Constructs a new <code>PageFaturaResponse</code>.
   * Representa\u00E7\u00E3o da resposta do recurso de planos de parcelamento
   * @alias module:model/PageFaturaResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageFaturaResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageFaturaResponse} obj Optional instance to populate.
   * @return {module:model/PageFaturaResponse} The populated <code>PageFaturaResponse</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoEnderecoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoEnderecoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoEnderecoResponse = factory(root.Pier.ApiClient, root.Pier.TipoEnderecoResponse);
  }
}(this, function(ApiClient, TipoEnderecoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageTipoEnderecoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoEnderecoResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoEnderecoResponse} The populated <code>PageTipoEnderecoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoEnderecoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoEnderecoResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './EmissorPierResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EmissorPierResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageEmissorPierResponse = factory(root.Pier.ApiClient, root.Pier.EmissorPierResponse);
  }
}(this, function(ApiClient, EmissorPierResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageEmissorPierResponse</code>.
   * {{{page_emissorpier_response_object_description}}}
   * @alias module:model/PageEmissorPierResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageEmissorPierResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageEmissorPierResponse} obj Optional instance to populate.
   * @return {module:model/PageEmissorPierResponse} The populated <code>PageEmissorPierResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [EmissorPierResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/EmissorPierResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Transferencia'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Transferencia'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTransferencias = factory(root.Pier.ApiClient, root.Pier.Transferencia);
  }
}(this, function(ApiClient, Transferencia) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageTransferencias</code>.
   * Lista de Transfer\u00C3\u00AAncias
   * @alias module:model/PageTransferencias
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTransferencias</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTransferencias} obj Optional instance to populate.
   * @return {module:model/PageTransferencias} The populated <code>PageTransferencias</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Transferencia]);
      }
  ...
  /**
   * @member {Array.<module:model/Transferencia>} content
   */

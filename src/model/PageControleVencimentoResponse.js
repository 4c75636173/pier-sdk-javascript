(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ControleVencimentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ControleVencimentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageControleVencimentoResponse = factory(root.Pier.ApiClient, root.Pier.ControleVencimentoResponse);
  }
}(this, function(ApiClient, ControleVencimentoResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageControleVencimentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageControleVencimentoResponse} obj Optional instance to populate.
   * @return {module:model/PageControleVencimentoResponse} The populated <code>PageControleVencimentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ControleVencimentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ControleVencimentoResponse>} content
   */

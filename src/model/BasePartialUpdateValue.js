(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.BasePartialUpdateValue = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>BasePartialUpdateValue</code>.
   * {{{base_partial_update_description}}}
   * @alias module:model/BasePartialUpdateValue
   * @class
   * @param servidor
   * @param usuario
   * @param senha
  ...
  /**
   * Constructs a <code>BasePartialUpdateValue</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BasePartialUpdateValue} obj Optional instance to populate.
   * @return {module:model/BasePartialUpdateValue} The populated <code>BasePartialUpdateValue</code> instance.
   */

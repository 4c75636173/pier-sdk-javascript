(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Dispositivo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Dispositivo'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageDispositivos = factory(root.Pier.ApiClient, root.Pier.Dispositivo);
  }
}(this, function(ApiClient, Dispositivo) {
  'use strict';

  /**
   * The PageDispositivos model module.
   * @module model/PageDispositivos
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageDispositivos</code>.
   * Lista de Dispositivos
   * @alias module:model/PageDispositivos
   * @class
   */
  ...
  /**
   * Constructs a <code>PageDispositivos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageDispositivos} obj Optional instance to populate.
   * @return {module:model/PageDispositivos} The populated <code>PageDispositivos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Dispositivo]);
      }
  ...
  /**
   * @member {Array.<module:model/Dispositivo>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ConfiguracaoRotativoDetalheResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ConfiguracaoRotativoDetalheResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageConfiguracaoRotativoResponse = factory(root.Pier.ApiClient, root.Pier.ConfiguracaoRotativoDetalheResponse);
  }
}(this, function(ApiClient, ConfiguracaoRotativoDetalheResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageConfiguracaoRotativoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageConfiguracaoRotativoResponse} obj Optional instance to populate.
   * @return {module:model/PageConfiguracaoRotativoResponse} The populated <code>PageConfiguracaoRotativoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ConfiguracaoRotativoDetalheResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ConfiguracaoRotativoDetalheResponse>} content
   */

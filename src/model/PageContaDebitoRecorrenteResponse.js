(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ContaDebitoRecorrenteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContaDebitoRecorrenteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageContaDebitoRecorrenteResponse = factory(root.Pier.ApiClient, root.Pier.ContaDebitoRecorrenteResponse);
  }
}(this, function(ApiClient, ContaDebitoRecorrenteResponse) {
  'use strict';

  /**
   * The PageContaDebitoRecorrenteResponse model module.
   * @module model/PageContaDebitoRecorrenteResponse
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageContaDebitoRecorrenteResponse</code>.
   * {{{page_conta_debito_recorrente_response_description}}}
   * @alias module:model/PageContaDebitoRecorrenteResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageContaDebitoRecorrenteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContaDebitoRecorrenteResponse} obj Optional instance to populate.
   * @return {module:model/PageContaDebitoRecorrenteResponse} The populated <code>PageContaDebitoRecorrenteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ContaDebitoRecorrenteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ContaDebitoRecorrenteResponse>} content
   */

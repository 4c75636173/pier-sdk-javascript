(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './TipoEstabelecimentoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TipoEstabelecimentoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageTipoEstabelecimentoResponse = factory(root.Pier.ApiClient, root.Pier.TipoEstabelecimentoResponse);
  }
}(this, function(ApiClient, TipoEstabelecimentoResponse) {
  'use strict';

  /**
   * The PageTipoEstabelecimentoResponse model module.
   * @module model/PageTipoEstabelecimentoResponse
   * @version 2.68.0
   */

  /**
   * Constructs a new <code>PageTipoEstabelecimentoResponse</code>.
   * {{{page_tipo_estabelecimento_response_description}}}
   * @alias module:model/PageTipoEstabelecimentoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageTipoEstabelecimentoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageTipoEstabelecimentoResponse} obj Optional instance to populate.
   * @return {module:model/PageTipoEstabelecimentoResponse} The populated <code>PageTipoEstabelecimentoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [TipoEstabelecimentoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/TipoEstabelecimentoResponse>} content
   */

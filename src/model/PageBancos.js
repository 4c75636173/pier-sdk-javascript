(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './Banco'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Banco'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageBancos = factory(root.Pier.ApiClient, root.Pier.Banco);
  }
}(this, function(ApiClient, Banco) {
  'use strict';

  /**
   * The PageBancos model module.
   * @module model/PageBancos
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageBancos</code>.
   * Lista de Bancos
   * @alias module:model/PageBancos
   * @class
   */
  ...
  /**
   * Constructs a <code>PageBancos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageBancos} obj Optional instance to populate.
   * @return {module:model/PageBancos} The populated <code>PageBancos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Banco]);
      }
  ...
  /**
   * @member {Array.<module:model/Banco>} content
   */

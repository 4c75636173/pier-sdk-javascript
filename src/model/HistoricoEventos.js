(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.HistoricoEventos = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>HistoricoEventos</code>.
   * Representa\u00C3\u00A7\u00C3\u00A3o do objeto que abstrai o hist\u00C3\u00B3rico de eventos
   * @alias module:model/HistoricoEventos
   * @class
   * @param idHistorico
   * @param dataHistorico
   * @param tipoHistorico
  ...
  /**
   * Constructs a <code>HistoricoEventos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HistoricoEventos} obj Optional instance to populate.
   * @return {module:model/HistoricoEventos} The populated <code>HistoricoEventos</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.HistoricoTelefone = factory(root.Pier.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>HistoricoTelefone</code>.
   * Objeto de resposta para historico de telefones
   * @alias module:model/HistoricoTelefone
   * @class
   */
  ...
  /**
   * Constructs a <code>HistoricoTelefone</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/HistoricoTelefone} obj Optional instance to populate.
   * @return {module:model/HistoricoTelefone} The populated <code>HistoricoTelefone</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './AtendimentoClienteResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AtendimentoClienteResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageAtendimentoClienteResponse = factory(root.Pier.ApiClient, root.Pier.AtendimentoClienteResponse);
  }
}(this, function(ApiClient, AtendimentoClienteResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageAtendimentoClienteResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageAtendimentoClienteResponse} obj Optional instance to populate.
   * @return {module:model/PageAtendimentoClienteResponse} The populated <code>PageAtendimentoClienteResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [AtendimentoClienteResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/AtendimentoClienteResponse>} content
   */

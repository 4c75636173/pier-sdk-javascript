(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './InscricaoAPNResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InscricaoAPNResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageInscricaoAPNResponse = factory(root.Pier.ApiClient, root.Pier.InscricaoAPNResponse);
  }
}(this, function(ApiClient, InscricaoAPNResponse) {
  'use strict';

  /**
   * The PageInscricaoAPNResponse model module.
   * @module model/PageInscricaoAPNResponse
   * @version 2.66.1
   */

  /**
   * Constructs a new <code>PageInscricaoAPNResponse</code>.
   * {{{page_inscricao_apn_resposta_descricao}}}
   * @alias module:model/PageInscricaoAPNResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageInscricaoAPNResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageInscricaoAPNResponse} obj Optional instance to populate.
   * @return {module:model/PageInscricaoAPNResponse} The populated <code>PageInscricaoAPNResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [InscricaoAPNResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/InscricaoAPNResponse>} content
   */

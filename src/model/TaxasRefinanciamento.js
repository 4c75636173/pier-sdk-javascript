(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.TaxasRefinanciamento = factory(root.Pier.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TaxasRefinanciamento model module.
   * @module model/TaxasRefinanciamento
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>TaxasRefinanciamento</code>.
   * Objeto de resposta para a valida\u00C3\u00A7\u00C3\u00A3o das Taxas de Refinanciamento
   * @alias module:model/TaxasRefinanciamento
   * @class
   */
  ...
  /**
   * Constructs a <code>TaxasRefinanciamento</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TaxasRefinanciamento} obj Optional instance to populate.
   * @return {module:model/TaxasRefinanciamento} The populated <code>TaxasRefinanciamento</code> instance.
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './ContaBancariaPortadorResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContaBancariaPortadorResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageContaBancariaPortadorResponse = factory(root.Pier.ApiClient, root.Pier.ContaBancariaPortadorResponse);
  }
}(this, function(ApiClient, ContaBancariaPortadorResponse) {
  'use strict';
  ...
  /**
   * Constructs a <code>PageContaBancariaPortadorResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageContaBancariaPortadorResponse} obj Optional instance to populate.
   * @return {module:model/PageContaBancariaPortadorResponse} The populated <code>PageContaBancariaPortadorResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [ContaBancariaPortadorResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/ContaBancariaPortadorResponse>} content
   */

(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', './StatusContestacaoResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StatusContestacaoResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Pier) {
      root.Pier = {};
    }
    root.Pier.PageStatusContestacaoResponse = factory(root.Pier.ApiClient, root.Pier.StatusContestacaoResponse);
  }
}(this, function(ApiClient, StatusContestacaoResponse) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageStatusContestacaoResponse</code>.
   * {{{page_status_contestacao_response_description}}}
   * @alias module:model/PageStatusContestacaoResponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PageStatusContestacaoResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageStatusContestacaoResponse} obj Optional instance to populate.
   * @return {module:model/PageStatusContestacaoResponse} The populated <code>PageStatusContestacaoResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [StatusContestacaoResponse]);
      }
  ...
  /**
   * @member {Array.<module:model/StatusContestacaoResponse>} content
   */

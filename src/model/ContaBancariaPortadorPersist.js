(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.ContaBancariaPortadorPersist = factory(root.Pier.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ContaBancariaPortadorPersist model module.
   * @module model/ContaBancariaPortadorPersist
   * @version 2.54.2
   */

  /**
   * Constructs a new <code>ContaBancariaPortadorPersist</code>.
   * ContaBancariaPortadorPersist
   * @alias module:model/ContaBancariaPortadorPersist
   * @class
   * @param idConta
   * @param banco
   * @param numeroAgencia
  ...
  /**
   * Constructs a <code>ContaBancariaPortadorPersist</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ContaBancariaPortadorPersist} obj Optional instance to populate.
   * @return {module:model/ContaBancariaPortadorPersist} The populated <code>ContaBancariaPortadorPersist</code> instance.
   */

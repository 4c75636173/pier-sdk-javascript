(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Pier.PageJob = factory(root.Pier.ApiClient, root.Pier.Job);
  }
}(this, function(ApiClient, Job) {
  'use strict';

  /**
   * The PageJob model module.
   * @module model/PageJob
   * @version 2.16.2
   */

  /**
   * Constructs a new <code>PageJob</code>.
   * Lista de Jobs
   * @alias module:model/PageJob
   * @class
   */
  ...
  /**
   * Constructs a <code>PageJob</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageJob} obj Optional instance to populate.
   * @return {module:model/PageJob} The populated <code>PageJob</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) { 
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Job]);
      }
  ...
  /**
   * @member {Array.<module:model/Job>} content
   */

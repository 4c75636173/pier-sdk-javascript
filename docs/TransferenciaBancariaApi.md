...
# **consultarUsingGET37**
> TransferenciaBancariaResponse consultarUsingGET37(id, idTransferencia, opts)
...
api.consultarUsingGET37(id, idTransferencia, opts, callback);
```
...
# **listarUsingGET42**
> PageTransferenciaBancariaResponse listarUsingGET42(id, opts)
...
api.listarUsingGET42(id, opts, callback);
```

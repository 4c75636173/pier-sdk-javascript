...
------------ | ------------- | ------------- | -------------
**idTipoEndereco** | **Integer** | C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o da Tipo Endere\u00C3\u00A7o (id) | 
...
**enderecoCorrespondencia** | **Boolean** | Indica se o endere\u00C3\u00A7o informado \u00C3\u00A9 o de correspond\u00C3\u00AAncia | 
